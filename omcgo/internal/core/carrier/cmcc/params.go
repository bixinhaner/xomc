...
// between CMCC-specific paths and unified internal names.
func buildParamMappings() (forward map[string]string, reverse map[string]string) {
	// CMCC-specific extensions mapped to unified names
	mappings := map[string]string{
		// CMCC LTE extensions
		"Device.X_CMCC.ENBId":           "enb_id",
		"Device.X_CMCC.ENBName":         "enb_name",
		"Device.X_CMCC.SiteName":        "site_name",
		"Device.X_CMCC.SiteId":          "site_id",
		"Device.X_CMCC.Region":          "region",
		"Device.X_CMCC.PMEnable":        "pm_enable",
		"Device.X_CMCC.PMInterval":      "pm_interval",
		"Device.X_CMCC.OMCDirectEnable": "omc_direct_enable",

		// CMCC 5G NR extensions
		"Device.X_CMCC.gNBName": "gnb_name",

		// Standard parameters with CMCC naming conventions
