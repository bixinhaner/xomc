...
// T-0178 P2 worker BackupCleanup(PRD §9.6)。
//
// 目标:周期清理 customDir 下的 .deleted.<ts> / .bak.<ts> / .tmp.<uuid> 残留,
...
// BackupCleanup 实现 customDir 下备份文件的周期清理(T-0178 §9.6)。
...
//
// 目录不存在(ENOENT)视为合法(首次部署未上传过任何自定义 XML),返 nil。
