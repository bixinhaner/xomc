...
-- 系统管理菜单的操作按钮
INSERT INTO menus (id, name, type, permission_key, parent_id, sort_order, status, created_at) VALUES
('11111111-1111-1111-1111-11111121101', '查询', 'button', 'system:user:query', '11111111-1111-1111-1111-111111111109', 1, 'normal', NOW()),
('11111111-1111-1111-1111-1111-11111121102', '添加', 'button', 'system:user:add', '11111111-1111-1111-1111-111111111109', 2, 'normal', NOW()),
('11111111-1111-1111-1111-1111-11111121103', '修改', 'button', 'system:user:edit', '11111111-1111-1111-1111-1111-111111111109', 3, 'normal', NOW()),
('11111111-1111-1111-1111-11111121104', '删除', 'button', 'system:user:delete', '11111111-1111-1111-1111-111111111109', 4, 'normal', NOW()),
('11111111-1111-1111-1111-1111-11111121105', '重置密码', 'button', 'system:user:resetpwd', '11111111-1111-1111-1111-111111111109', 5, 'normal', NOW());
