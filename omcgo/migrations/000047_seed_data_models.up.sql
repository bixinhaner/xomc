...
--
-- 注意：此文件替换 000046 的数据，需先删除 000046 插入的记录以避免
-- 部分唯一索引冲突（idx_dm_active_carrier_default, idx_dm_active_oui,
-- idx_dm_active_product）
-- ============================================================================

-- 删除 000046 插入的旧数据（ID 前缀为 30000000-0001-4000-8000-0000000000XX）
DELETE FROM data_model_definitions
WHERE id IN (
    '30000000-0001-4000-8000-000000000001',  -- cmcc lte carrier_default
    '30000000-0001-4000-8000-000000000002',  -- cmcc nr carrier_default
    '30000000-0001-4000-8000-000000000003',  -- ctcc lte carrier_default
    '30000000-0001-4000-8000-000000000004',  -- cucc lte carrier_default
    '30000000-0001-4000-8000-000000000010',  -- cmcc lte oui 001A2B
    '30000000-0001-4000-8000-000000000020'   -- cmcc lte product 001A2B SmallCell-LTE
);
