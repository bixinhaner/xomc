...
SELECT create_hypertable('kpi_values', 'time', chunk_time_interval => INTERVAL '1 day', if_not_exists => TRUE);
...
-- Continuous aggregate: hourly rollup of PM counters
