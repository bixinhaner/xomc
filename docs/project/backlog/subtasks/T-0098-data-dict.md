...
> **2026-05-07 前戏完成升格**：P1-01..P1-06 6 条 **State→planned / Sprint=wave-3 / Owner=Claude**；wave-batched 模式（dev-pipeline §C.1）准入，Skip S0/S1，Footer 引用 `AI承诺对峙清单.md` W3 + `参数-KPI-告警-整合-实施计划.md`；可直接 `/dev-pipeline pick T-0098-P1-01` 开车。**commit 形态**：6 commit + 单 PR（每 commit footer 各挂 `Backlog: T-0098-P1-0N`，PR 描述聚合 6 条；保留 D8=A 迁移 atomic 同时不破坏 §B6 footer 一对一规则）。P2-P5 30 条仍 triaged 待下次 sprint planning。

| ID | Title | Type | Domain | Prio | State | Owner | Est | Deps | Sprint | Risk/PRD | Updated | Notes |
|----|-------|------|--------|------|-------|-------|-----|------|--------|----------|---------|-------|
| T-0098-P1-01 | 创建 internal/core/dictloader/（scanner+lifecycle+cache_version+report）+ DictLoaderConfig | feat | infra | P2 | planned | Claude | M | — | wave-3 | R-T0098-04 / `参数-KPI-告警-整合-实施计划.md` | 2026-05-07 | Phase 1 共享设施层；D8=A 单 PR 合 P1；出口=单测 + provider 框架可注册 Loader 接口 |
| T-0098-P1-02 | 迁移 000057_products.sql — products + product_class_patterns + devices.product_id 列 | feat | F02 | P2 | planned | Claude | S | — | wave-3 | R-T0098-04 / ~~R-T0098-11~~ Closed | 2026-05-07 | **2026-05-07 D4 自动满足**：products.xml 9714 bytes / 15 产品 / 29 正则已在 commit 50fa1a0c 入库（实施计划 §1.4 Gap 分析有误）；R-T0098-11 → Closed by reality；P1-02 仅写 schema 迁移 + up/down 配对；scripts/check-migrations.sh 通过 |
| T-0098-P1-03 | 迁移 000058_param_dictionary.sql — param_models + param_mappings(is_storable) + discovered_param_mappings(product_id+swVersion 主键) + standard_params + 既有表 param_model_id 列 | feat | F02 | P2 | planned | Claude | M | T-0098-P1-02 | wave-3 | R-T0098-04 | 2026-05-07 | D8=A 单 PR；索引校验；范式重写关键节点 |
| T-0098-P1-04 | 迁移 000059_alarm_dictionary.sql — alarm_severity_levels + 4 行种子 + alarm_definitions 新建 + alarms_active.is_unknown ADD COLUMN | feat | F04 | P2 | planned | Claude | M | — | wave-3 | R-T0098-03 | 2026-05-07 | D2=B DROP+CREATE 路径；4 行 severity 种子可查；旧 alarm_libraries 处置见 P5-06 |
| T-0098-P1-05 | KPI 表名对齐文档（保留现状） | docs | F03 | P2 | planned | Claude | S | — | wave-3 | R-T0098-02 (closed) | 2026-05-07 | **D1=A 决议保留 indicator_unit/rela_platform_indicator_formula_*/enabled_pm_indicators_*；本任务降级为 docs**：更新设计 footnote 说明命名差异；不再写 000060 迁移 |
| T-0098-P1-06 | 4 个 Loader 实现（product/loader.go + parammodel/loader.go + indicator/loader.go 增强 + alarm/definition/loader.go）+ provider 接线 | feat | infra+F02+F03+F04 | P2 | planned | Claude | L | T-0098-P1-01,T-0098-P1-02,T-0098-P1-03,T-0098-P1-04,T-0098-P1-05 | wave-3 | R-T0098-04 / ~~R-T0098-11~~ Closed | 2026-05-07 | 启动后 omcgo-app 各域行数 = 设计基线（参数 9+4781+2001 / 指标 1764+6254+27 / 告警 442+4 / 产品 15+29）；**products.xml lenient unmarshal**：缺 `enableUnknownAlarm` 属性时 Go bool 默认值 false（与 design schema DEFAULT false 一致）；可选一次性补 15 产品显式属性（cosmetic，P1-04/P1-06 同 PR） |
| T-0098-P2-01 | ProductRegistry — productClass 全局正则路由 + L1 sync.Map + L2 Redis 缓存 + 引用校验 | feat | F02 | P2 | triaged | — | M | T-0098-P1-06 | — | R-T0098-08 | 2026-05-07 | FAP 兜底正则在最末；Phase 2 三轨并行起点 |
| T-0098-P2-02 | ParamModel Registry + Translator — 精简（去 productClass routing）+ O(1) 双向翻译（standardPath ↔ privatePath）+ discovered → default 降级 | feat | F02 | P2 | triaged | — | L | T-0098-P2-01 | — | R-T0098-05 / R-T0098-08 | 2026-05-07 | D9=B feature flag param_registry.use_new 保护；关键路径节点 |
| T-0098-P2-03 | ParamModel Intersect — 基站上传 paramModel ∩ 默认；按 device_attrs_override 决定元属性来源；写 discovered_param_mappings | feat | F02 | P2 | triaged | — | M | T-0098-P2-02 | — | R-T0098-08 | 2026-05-07 | 配合 P2-06 model_upload；元属性覆盖策略实现 |
| T-0098-P2-04 | provision/sync.go 重写 Path B — 删 Phase1GPNs 阶段 + 改用 ParamMapping 列表去重前缀 + GPV 对象前缀 + Translator 落库 + is_storable 过滤 | ref | F02 | P2 | triaged | — | L | T-0098-P2-02 | — | R-T0098-06 / R-T0098-08 | 2026-05-07 | engine_test.go 1082 行同步重构（不留残留）；CPE simulator 兜底 |
| T-0098-P2-05 | provision/orchestrator.go 改造 Path A — 模板 Parameters JSON key 改 standardPath；SPV/GPV 步骤生成时翻译为 privatePath | ref | F02 | P2 | triaged | — | M | T-0098-P2-02 | — | R-T0098-08 | 2026-05-07 | 模板兼容旧数据评估；可与 P2-04 同 PR |
| T-0098-P2-06 | provision/model_upload.go — enable_filetype11 决策（false 跳过 Upload；true 设备不支持 SOAP Fault → 降级默认映射；调用 Intersect 写 discovered） | ref | F02 | P2 | triaged | — | M | T-0098-P2-01,T-0098-P2-03 | — | R-T0098-08 | 2026-05-07 | enable_filetype11 三态分支；运营商可配 |
| T-0098-P2-07 | device/device_param_handler.go — dmRegistry → paramRegistry，新 mapping-based validator | ref | F02 | P2 | triaged | — | S | T-0098-P2-02 | — | R-T0098-08 | 2026-05-07 | 6 消费者改造 simplest case |
| T-0098-P2-08 | interop/runner.go + interop/validator.go — 切到新 ParamRegistry，改校验 ParamMapping 元属性 | ref | F10 | P2 | triaged | — | S | T-0098-P2-02 | — | R-T0098-08 | 2026-05-07 | F10 模块独立切换 |
| T-0098-P2-09 | KPI loader enabled 属性解析 + 多文件 OR 合并 + operator_code='default' 行刷新语义（不动其他 operator） | feat | F03 | P2 | triaged | — | M | T-0098-P1-06 | — | — | 2026-05-07 | **D10=A 吸收 T-0095 标准报表/站点报表 KPI 工作**；分桶刷新逻辑核心 |
| T-0098-P2-10 | AlarmDefinition Registry + 接收路径未命中 fallback — 查 device.product_id → product.enable_unknown_alarm；true 写 fallback severity=Warning is_unknown=true，false 丢弃 + INFO + Prom 指标 alarm_unknown_total | feat | F04 | P2 | triaged | — | M | T-0098-P2-01 | — | R-T0098-03 | 2026-05-07 | enable_unknown_alarm 策略实现；治理闭环准备 |
| T-0098-P2-11 | PM worker 接 KPI Registry enabled 过滤（条件性，operator_code 桶生效） | feat | F03 | P2 | triaged | — | S | T-0098-P2-09 | — | — | 2026-05-07 | **D10=A 吸收 T-0095**；如适用才做；非必需 |
