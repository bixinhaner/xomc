...
| T-0090-c | MML 后端 RBAC 私有命令过滤 — service.go + pg_repository.go ListCustomCommands deny-by-default + self-fallback OR group-share + RoleQuerier 小接口 — **done 2026-05-12**（commit `2c114a40` 10 文件 +686/-14；EXISTS 子查询 + Squirrel 参数化全防 R-NEW-2；6 unit test 覆盖 admin_a/admin_b/admin_c/admin_d/QuerierError/NoQuerier 全状态空间 + 跨用户隔离反退化测试；2 e2e claim 验端点契约；/security-review 强制审查 0 P0/P1）| feat | F06/mml+admin | P2 | done | Claude | M-L (3-4d) | T-0090-a ✅, T-0090-b ✅ | sprint-10 (pull-forward) | R-NEW-2 已 mitigate / backlog T-0090 ⑥⑦ | 2026-05-12 | Closing Evidence → `docs/review-report/20260512/verify-T-0090-c.md` + `REVIEW_T-0090-c_chenbo01_mml.md`；解锁 T-0090-d (deps ready) |
| T-0090-d | MML 前端私有命令页面新建 — PrivateCommand 独立列表页 + 复用 AddTemplateModal 间接消费 T-0090-a 公共组件 + 列表自动按 T-0090-c RBAC 过滤 + 路由注册 + **附带修复 FE/BE query param 名称不一致 — done 2026-05-12**（commit `396cb76d` 7 文件 +459/-6；0 业务逻辑复制粘贴；R-NEW-3 mitigation 完整闭环；T-0090 umbrella 4/4 全闭可关闭）| feat | frontend | P2 | done | Claude | S (1-2d) | T-0090-a ✅, T-0090-c ✅ | sprint-10 (pull-forward) | R-NEW-3 闭环 mitigate / backlog T-0090 ⑤ | 2026-05-12 | Closing Evidence → `docs/review-report/20260512/verify-T-0090-d.md` + `REVIEW_T-0090-d_chenbo01_mml.md`；**T-0090 umbrella 4/4 全闭** |
