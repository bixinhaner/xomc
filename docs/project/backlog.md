...
| `done` | 54 | — | +T-0070 (BackupSchedule UI 重设计, R-102 Backup 3/4 闭环)；+T-0016 (Backup Tasks 4 hook + FTP fallback)；+T-0021 (Software 回滚增强, R-101 完整闭环)；+T-0019 / +T-0018 / +T-0025 / +T-0022 / +T-0012 / +T-0015 |
| `in_dev` | 1 | — | T-0027 KPI（FREEZE 冲突，PgM 待决） |
| `planned` | 6 | — | 不变 |
| `triaged` | 8 | — | -1 (T-0070 done)；P1/P2 暂未排期；剩 T-0071/0072（Backup Policy/Restore） + 6 其他 |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
