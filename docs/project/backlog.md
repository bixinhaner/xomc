...
| 指标 | 当前 | 目标 | 备注 |
|------|------|------|------|
| Total tasks | 80 | — | +3（T-0078/0079/0080 T-0072 followup 2026-04-29）|
| `done` | 59 | — | +T-0072 (备份恢复后端 MVP — TR-069 Download(FileType=3) + 流式解压)；+T-0077 / +T-0074 / +T-0073 / +T-0071 / +T-0070 / +T-0016 / +T-0021 / +T-0019 / +T-0018 / +T-0025 / +T-0022 / +T-0012 / +T-0015 |
| `in_dev` | 1 | — | T-0027 KPI（FREEZE 冲突，PgM 待决） |
| `planned` | 6 | — | 不变 |
| `triaged` | 11 | — | +3 T-0078/0079/0080 -1 T-0072 done = net +2；剩 T-0072 followup 3 + T-0075/0076 + 既有 backlog |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
...
| T-0080 | migration 000038 重复 hotfix（rename 一个 000038_*.sql → 000049 让 goose 可解析；pre-existing 历史遗留，T-0072 review-agent 发现）| fix | infra/migration | P0 | triaged | Go | S | — | CLAUDE.md §5.5 / T-0072 review finding | sprint-07 | 2026-04-29 |
