...
| `done` | 153 | — | 详细 Closing Evidence → `backlog/done/2026Q2.md`（含 T-0095/T-0098/T-0101..T-0112/T-0099/T-0097/T-0030 + T-0115/T-0114/T-0116 + T-0113 + T-0090 全系列 + T-0096 + T-0102-a + **+T-0101 umbrella 9/9 全闭 2026-05-12（dispatcher 调度引擎完整骨架就位：a 接口 / b 路由 / c 并发 / d 持久化 / e 聚合 / f 策略 / g 原子 / h 回滚 / i 恢复；R-O01 9 层 mitigation；35+ 反退化单测）**）|
