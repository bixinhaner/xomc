...
| T-0030 | F10 互操作用例库扩充（GA 级质量补强）— S0/S1/S2 done 2026-05-11；Phase 1 (sprint-10): 14→≥30 用例 + 新建 Inform category + 引入 negative path + e2e 3→≥6 claim；R-202 闭环至 Mitigating；Phase 2 留 sprint-11+ | feat | F10 | P2 | planned | Claude | L | — | R-202 / `docs/project/prd/F10-interop-testing-coverage.md` | sprint-10 | 2026-05-11 |
