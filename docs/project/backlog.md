...
| 指标 | 当前 | 目标 | 备注 |
|------|------|------|------|
| Total tasks | 89 | — | +1 (T-0090 MML 控制台公私命令新增页面 UX 整改) +5（T-0085/T-0086/T-0087/T-0088/T-0089 T-0075 followup）|
| `done` | 64 | — | +T-0075 (backup 加密执行 AES-256-GCM 信封加密 — **R-102 final core 闭环**)；+T-0076 / +T-0079 / +T-0078 / +T-0080 / +T-0072 / +T-0077 / +T-0074 / +T-0073 / +T-0071 / +T-0070 / +T-0016 / +T-0021 / +T-0019 / +T-0018 / +T-0025 / +T-0022 / +T-0012 / +T-0015 |
| `in_dev` | 1 | — | T-0027 KPI（FREEZE 冲突，PgM 待决） |
| `planned` | 6 | — | 不变 |
| `triaged` | 14 | — | +5 T-0085..T-0089 -1 T-0075 done = net +4；剩 T-0082/0083/0084/0085/0086/0087/0088/0089 (R-102 enhancement followups) + 既有 |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
...
| T-0082 | backup 磁盘阈值告警 — poll MinIO bucket size + alarm.raised/cleared 边沿触发 + 5 metric（无 schema 变更，复用 MaxStorageGB×AlertThresholdPercent；severity 联合 T-0084）| feat | F06/backup+ops | P2 | in_review | Claude | M | T-0076 ✅ | R-102 / `prd/T-0082-backup-disk-threshold.md` | sprint-08 | 2026-04-29 |
| T-0083 | backup 多设备 orphan 文件 reaper — list-prefix scan with taskID8 OR 新表 backup_files（T-0076 followup；闭环 multi-device backup 物理清理完整性）| feat | F06/backup | P3 | triaged | Go | M | T-0076 ✅ | R-102 / T-0076 followup | sprint-08 | 2026-04-29 |
| T-0084 | backup AlertSeverity policy-driven 化（关闭 policy_alarm_publisher.go TODO；与 T-0082 disk threshold 联合 schema migration）| feat | F06/backup+alarm | P3 | triaged | 电信+Go | S | T-0082 | R-102 followup | sprint-08 | 2026-04-29 |
...
| T-0085 | backup 加密 AES-256-CBC + ChaCha20-Poly1305 算法实施（mirror T-0077 lz4/bzip2 模式；T-0075 followup）| feat | F06/backup+security | P3 | triaged | 电信+SecOps | M | T-0075 ✅ | R-102 / T-0075 followup | sprint-08 | 2026-04-29 |
...
| T-0088 | 前端 BackupPolicy encryption Tag 条件化（AES-256-GCM + KEK avail → "已生效" green tag；其它保 warning）| feat | frontend | P3 | triaged | 前端 | S | T-0075 ✅ | R-102 / T-0075 followup | sprint-08 | 2026-04-29 |
| T-0089 | backup decrypt 并发 semaphore 防 DoS（64MB×N concurrent buffer 内存放大；review M-4 follow-up）| feat | F06/backup+ops | P3 | triaged | Go+运维 | S | T-0075 ✅ | T-0075 review M-4 | sprint-08 | 2026-04-29 |
...
|----|-------|-------------|---------|-------|
| T-0090 | MML 控制台 公/私命令新增页面 UX 整改（操作类型差异化 + 字段精简 + 编码 textarea） | @chenbo01 | 2026-04-29 | 三条诉求：① 先选"操作类型"再让用户输入"命令编码"，按操作类型（如 MOD / LST / ADD / RMV）差异化前端页面（MOD 需提供"修改值"输入框，其他类型按需）；② 删除"参数配置"、"所属分类"、"适用产品类型"三个字段；③ "命令编码"字段控件由 input 改为 textarea。Domain=frontend (omcmb/webcode 公私命令新增页面)。**等下周一 Triage 判 Type/Prio/Est** — 候选 Type=feat 或 ref（取决于是否含后端模型变更），候选 Prio=P2（UX 整改非阻塞 RC/GA） |
