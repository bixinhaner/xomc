...
| `done` | 53 | — | +T-0016 (前端 Backup Tasks 4 hook + FTP fallback, R-102 部分关闭)；+T-0021 (Software 回滚增强, R-101 完整闭环)；+T-0019 / +T-0018 / +T-0025 / +T-0022 / +T-0012 / +T-0015 |
| `in_dev` | 1 | — | T-0027 KPI（FREEZE 冲突，PgM 待决） |
| `planned` | 6 | — | -1 (T-0016 done) |
| `triaged` | 9 | — | P1/P2，暂未排期；+3 T-0016 followups (T-0070/0071/0072) |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
