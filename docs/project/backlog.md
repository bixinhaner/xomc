...
| T-0100-P4-B | license_logs 6 月归档 cron — monitor.archiveOldLogs(ctx) → MinIO `license-logs/{YYYY-MM}.jsonl.gz` + DB DELETE > 6 月；weekly schedule | feat | F06/license+ops | P2 | done | Claude | M (~1-2d) | T-0100-P3 ✅ | `prd/F06-license.md` §5.4.5；archiver.go + monitor.SetArchiver | wave-3-finishing | 2026-05-09 |
