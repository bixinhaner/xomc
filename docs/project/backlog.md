...
| 指标 | 当前 | 目标 | 备注 |
|------|------|------|------|
| Total tasks | 83 | — | +3（T-0082/T-0083/T-0084 T-0076 followup）|
| `done` | 63 | — | +T-0076 (cleanup Phase 2 物理删除 + dashboard)；+T-0079 / +T-0078 / +T-0080 / +T-0072 / +T-0077 / +T-0074 / +T-0073 / +T-0071 / +T-0070 / +T-0016 / +T-0021 / +T-0019 / +T-0018 / +T-0025 / +T-0022 / +T-0012 / +T-0015 |
| `in_dev` | 1 | — | T-0027 KPI（FREEZE 冲突，PgM 待决） |
| `planned` | 6 | — | 不变 |
| `triaged` | 10 | — | +3 T-0082/0083/0084 -1 T-0076 done = net +2；剩 T-0075 + T-0082..0084 + 既有 |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
...
| T-0075 | backup 加密执行 — AES-256-GCM 信封加密（KEK env-var + 每文件 DEK + AAD=filename + buffer-then-encrypt 64MB 上限；CBC/ChaCha20 stub；KMS 拆 T-0086；**安全敏感**）| feat | F06/backup+security | P1 | in_dev | Claude | L | T-0071 ✅, T-0074 ✅, T-0072 ✅ | R-102 / `prd/T-0075-backup-encryption-aes256gcm.md` | sprint-07 | 2026-04-29 |
