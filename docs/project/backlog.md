...
| `in_design` | 0 | — | — |
| `planned` | 6 | — | P1/P2/P3 22 条 done 后剩 6 条来自其他任务；T-0098 P4/P5 仍 triaged |
| `triaged` | 21 | — | T-0098 14 sub-task（P4-P5）；剩 T-0030 / T-0090 / T-0091 / T-0093 / T-0035 / T-0096 / T-0097 不阻塞主链路 |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
