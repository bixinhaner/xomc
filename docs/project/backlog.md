...
| 指标 | 当前 | 目标 | 备注 |
|------|------|------|------|
| Total tasks | 77 | — | +1 T-0077（T-0074 followup 2026-04-29，lz4/bzip2 + frontend disable + zstd encoder pool）|
| `done` | 57 | — | +T-0074 (backup 压缩集成 MVP — gzip/zstd 流式 + executor file_type 2→3 fix)；+T-0073 / +T-0071 / +T-0070 / +T-0016 / +T-0021 / +T-0019 / +T-0018 / +T-0025 / +T-0022 / +T-0012 / +T-0015 |
| `in_dev` | 1 | — | T-0027 KPI（FREEZE 冲突，PgM 待决） |
| `planned` | 6 | — | 不变 |
| `triaged` | 10 | — | +1 T-0077（T-0074 followup）, -1 T-0074 done = net 0；剩 T-0072/0075/0076/0077 4 个 backup 子模块 followup |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
...
| T-0077 | backup 压缩 lz4 + bzip2 算法实施（含 deps `pierrec/lz4/v4` + `dsnet/compress/bzip2`）+ frontend BackupPolicy lz4/bzip2 dropdown disable when EnableCompression=true + zstd encoder pool 优化（T-0074 followup）| feat | F06/backup+frontend | P3 | triaged | Go+前端 | S | T-0074 ✅ | R-102 / T-0074 followup | sprint-08 | 2026-04-29 |
