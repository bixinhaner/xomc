...
| `done` | 138 | — | 详细 Closing Evidence → `backlog/done/2026Q2.md`（含 T-0095/T-0098/T-0101..T-0112/T-0099/T-0097/T-0030 + T-0115 CSV export MVP + T-0114 F10 fault-inject + T-0116 F10 设备矩阵 + T-0113 F06 ops wave 合规债清账 + T-0090-a MML Console UX FE-only 4 子项 + **+T-0090-b mml_custom_command.product_types 真删 2026-05-12（sprint-11 work pull-forward / live DB up/down/up 三次演练 / 6 行数据丢失 R-NEW-1 接受 / 解锁 T-0090-c）**）|
...
| `triaged` | 4 | — | T-0091 / T-0093 (backup 外部 trigger) / T-0035 (XL 待 S2 拆) / T-0096 (deps T-0090 跟随) — T-0113 升 done 2026-05-11 / T-0114-T-0116 三 F10 Phase 3 task 单晚全闭 |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
