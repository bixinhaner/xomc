...
| 指标 | 当前 | 目标 | 备注 |
|------|------|------|------|
| Total tasks | 153 | — | 含 T-0098 umbrella + 36 sub-task；2026-05-10 新增 12 umbrella（T-0101..T-0112 F06 运维管理）+ 66 sub-task；2026-05-11 +T-0113 F06 ops 合规债清账 + T-0114/T-0115/T-0116 F10 Phase 3 三 task（fault-inject / 报告 export / 设备矩阵）；2026-05-13 test.md §5 续测登 T-0119/T-0120/T-0121/T-0122（§5.2/5.3/5.5/§5.6-unknown 环境不可达 Proposed）；变更明细见 changelog |
...
| `triaged` | 2 | — | T-0091 / T-0035 (XL 待 S2 拆) — T-0093 升 done 2026-05-12（用户 trigger 视为生效；SFTP/FTPS 真 probe 落地）|
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
