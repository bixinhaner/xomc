...
| `done` | 158 | — | 详细 Closing Evidence → `backlog/done/2026Q2.md`（含 T-0095/T-0098/T-0101..T-0112/T-0099/T-0097/T-0030 + T-0115/T-0114/T-0116 + T-0113 + T-0090 全系列 + T-0096 + T-0102-a + T-0101 umbrella + T-0093 backup SFTP/FTPS + T-0102-b 真入队 + T-0102-c 真 RPC 派发 + **+T-0102-d MML 多帧 SSE + T-0102-e per-device 超时/重试/限流 2026-05-12（T-0102 umbrella 5/5 全闭：a SSEHub Stats + b 真入队 + c 5 动作真派发到 ACS + d per-device frame + e 60s/3retry/5per-sec；40+ unit test；R-O02 mitigation 完整闭环）**）|
