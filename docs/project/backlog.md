...
| `done` | 156 | — | 详细 Closing Evidence → `backlog/done/2026Q2.md`（含 T-0095/T-0098/T-0101..T-0112/T-0099/T-0097/T-0030 + T-0115/T-0114/T-0116 + T-0113 + T-0090 全系列 + T-0096 + T-0102-a + T-0101 umbrella + T-0093 backup SFTP/FTPS + **+T-0102-b 真入队 endpoint + T-0102-c 真 RPC 派发 2026-05-12（POST /ops/commands/rpc → OpsTask 真持久化 → executor.Run fan-out per device → internal/task → ACS 引擎；25 unit test：7 enqueue + 18 dispatcher；R-O02 mitigation 又深一层）**）|
