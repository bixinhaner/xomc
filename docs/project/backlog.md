...
| `done` | 137 | — | 详细 Closing Evidence → `backlog/done/2026Q2.md`（含 T-0095/T-0098/T-0101..T-0112/T-0099/T-0097/T-0030 + T-0115 CSV export MVP + T-0114 F10 fault-inject + T-0116 F10 设备矩阵 + T-0113 F06 ops wave 合规债清账 + **+T-0090-a MML Console UX FE-only 4 子项 2026-05-12（sprint-11 work pull-forward 进 sprint-10 buffer / 抽 2 公共组件 mitigate R-NEW-3）**）|
