...
| 指标 | 当前 | 目标 | 备注 |
|------|------|------|------|
| Total tasks | 80 | — | 不变（T-0078 done） |
| `done` | 61 | — | +T-0078 (前端 RestoreData wholesale rewrite)；+T-0080 / +T-0072 / +T-0077 / +T-0074 / +T-0073 / +T-0071 / +T-0070 / +T-0016 / +T-0021 / +T-0019 / +T-0018 / +T-0025 / +T-0022 / +T-0012 / +T-0015 |
| `in_dev` | 1 | — | T-0027 KPI（FREEZE 冲突，PgM 待决） |
| `planned` | 6 | — | 不变 |
| `triaged` | 9 | — | -1 T-0078 done；剩 T-0079 (T-0072 followup task-path 链路) + T-0075/0076 + 既有 backlog |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
...
| T-0079 | backup_task → file_path 链路回填（EventBus pub-sub + filename embed taskID8 + first-write-wins + restore_by_task_id 新 endpoint）| feat | F06/backup | P2 | in_dev | Claude | M | T-0072 ✅, T-0007 ✅ | R-102 / `prd/T-0079-backup-task-filepath-linkage.md` | sprint-07 | 2026-04-29 |
