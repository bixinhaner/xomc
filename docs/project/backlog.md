...
| 指标 | 当前 | 目标 | 备注 |
|------|------|------|------|
| Total tasks | 76 | — | +1 T-0076（T-0073 Phase 2 followup 2026-04-29）|
| `done` | 56 | — | +T-0073 (backup cleanup Phase 1 — DB cleanup cron + 失败告警发布；Phase 2 = T-0076)；+T-0071 / +T-0070 / +T-0016 / +T-0021 / +T-0019 / +T-0018 / +T-0025 / +T-0022 / +T-0012 / +T-0015 |
| `in_dev` | 1 | — | T-0027 KPI（FREEZE 冲突，PgM 待决） |
| `planned` | 6 | — | 不变 |
| `triaged` | 10 | — | +1 T-0076（T-0073 Phase 2 followup), -1 T-0073 done = net 0；剩 T-0072/0074/0075/0076 4 个 backup 子模块 followup |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
...
| T-0074 | backup 压缩集成 MVP（acs/upload/handler 流式压缩 + gzip/zstd 实施 + lz4/bzip2 stub + executor file_type 2→3 fix）| feat | F06/backup | P3 | in_dev | Claude | M | T-0071 ✅ | R-102 / `prd/T-0074-backup-executor-compression.md` | sprint-07 | 2026-04-29 |
