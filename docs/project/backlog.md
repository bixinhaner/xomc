...
| 指标 | 当前 | 目标 | 备注 |
|------|------|------|------|
| Total tasks | 88 | — | +5（T-0085/T-0086/T-0087/T-0088/T-0089 T-0075 followup）|
...
| T-0082 | backup 磁盘阈值告警 — poll MinIO bucket size + alarm.raised when used > policy.alert_threshold_percent（T-0076 followup；与 T-0084 severity 联合设计）| feat | F06/backup+ops | P2 | triaged | 运维+Go | M | T-0076 ✅ | R-102 / T-0076 followup | sprint-08 | 2026-04-29 |
