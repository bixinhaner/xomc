...
| T-0100-P4-B | license_logs 6 月归档 cron — monitor.archiveOldLogs(ctx) → MinIO `license-logs/{YYYY-MM}.jsonl.gz` + DB DELETE > 6 月；weekly schedule | feat | F06/license+ops | P2 | triaged | — | M (~1-2d) | T-0100-P3 ✅ | `prd/F06-license.md` §5.4.5 | — | 2026-05-09 |
| T-0100-P4-C | OEM 公钥强校验 — `configs/oem_public_keys/*.pem` 加载 + RSA-PSS 嵌入 JSON `signature` 字段 + strict config 开关；替换 P3 stub `VerifySignature` | feat | F06/license+admin+ops | P2 | triaged | — | M (~1-2d) | T-0100-P3 ✅ + Q4=B 决议 | `prd/F06-license.md` §5.3.1 §16 Q4 决议 | — | 2026-05-09 |
