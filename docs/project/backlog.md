...
| `done` | 154 | — | 详细 Closing Evidence → `backlog/done/2026Q2.md`（含 T-0095/T-0098/T-0101..T-0112/T-0099/T-0097/T-0030 + T-0115/T-0114/T-0116 + T-0113 + T-0090 全系列 + T-0096 + T-0102-a + T-0101 umbrella + **+T-0093 backup SFTP/FTPS 真 auth probe 2026-05-12（x/crypto/ssh + crypto/tls 双协议密码探活 / 7 新单测 race 全过 / 公共构造函数签名向后兼容）**）|
