...
| `done` | 133 | — | 详细 Closing Evidence → `backlog/done/2026Q2.md`（含 T-0095/T-0098/T-0101..T-0112/T-0099/T-0097/T-0030 + **+T-0115 F10 互操作验收报告 CSV export MVP 2026-05-11（commit b6d42934）**）|
...
| `triaged` | 7 | — | T-0091 / T-0093 (backup 外部 trigger) / T-0035 (XL 待 S2 拆) / T-0096 (deps T-0090 跟随) / T-0113 (F06 ops 合规债清账) / T-0114 (F10 fault-inject P3) / T-0116 (F10 设备矩阵 XL P3) — T-0115 升 done MVP 2026-05-11 |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
...
| T-0116 | F10 互操作设备型号矩阵参数化 — TestCase struct 加 target_device_models[] 字段 + runner 按设备型号过滤用例 + carrier×model 矩阵执行 + 报告分组；T-0030 Phase 3 拆出独立 task；架构改动较大 | feat | F10 | P3 | XL→需 S2 拆 | T-0030 ✅ + T-0115 ✅（报告改造已交付 CSV MVP）| — | XL 任务需 sprint planning 拆 sub-task；改 model.go + runner.go + cases struct + 注册路径；可复用 T-0115 的 WriteCSVReport 加 carrier×model 分组 |
