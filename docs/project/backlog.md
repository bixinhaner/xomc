...
| 指标 | 当前 | 目标 | 备注 |
|------|------|------|------|
| Total tasks | 77 | — | 不变（T-0077 done） |
| `done` | 58 | — | +T-0077 (backup 压缩 lz4 + bzip2 算法实施)；+T-0074 / +T-0073 / +T-0071 / +T-0070 / +T-0016 / +T-0021 / +T-0019 / +T-0018 / +T-0025 / +T-0022 / +T-0012 / +T-0015 |
| `in_dev` | 1 | — | T-0027 KPI（FREEZE 冲突，PgM 待决） |
| `planned` | 6 | — | 不变 |
| `triaged` | 9 | — | -1 T-0077 done；剩 T-0072/0075/0076 3 个 backup 子模块 followup（restore + 加密 + cleanup Phase 2）|
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
