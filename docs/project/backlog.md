...
| 指标 | 当前 | 目标 | 备注 |
|------|------|------|------|
| Total tasks | 80 | — | 不变（T-0080 done） |
| `done` | 60 | — | +T-0080 (migration 000038 重复 hotfix)；+T-0072 / +T-0077 / +T-0074 / +T-0073 / +T-0071 / +T-0070 / +T-0016 / +T-0021 / +T-0019 / +T-0018 / +T-0025 / +T-0022 / +T-0012 / +T-0015 |
| `in_dev` | 1 | — | T-0027 KPI（FREEZE 冲突，PgM 待决） |
| `planned` | 6 | — | 不变 |
| `triaged` | 10 | — | -1 T-0080 done；剩 T-0078/0079 (T-0072 followup) + T-0075/0076 + 既有 backlog |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
...
| T-0078 | 前端 RestoreData wholesale rewrite + 3 hook + i18n（**MVP 改手动路径输入**；filemanager 路径架构不匹配 → 文件浏览器拆 T-0081 / T-0079 后做）| feat | frontend | P1 | in_dev | Claude | L | T-0072 ✅ | R-102 / `prd/T-0078-frontend-restoredata-rewrite.md` | sprint-07 | 2026-04-29 |
