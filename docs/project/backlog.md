...
| `done` | 139 | — | 详细 Closing Evidence → `backlog/done/2026Q2.md`（含 T-0095/T-0098/T-0101..T-0112/T-0099/T-0097/T-0030 + T-0115/T-0114/T-0116 + T-0113 + T-0090-a + T-0090-b + **+T-0090-c MML 私有命令 RBAC 过滤 2026-05-12（self-fallback + group-share + deny-by-default / 6 RBAC unit test 跨用户隔离 / /security-review 0 P0/P1 / 解锁 T-0090-d）**）|
