...
| `done` | 159 | — | 详细 Closing Evidence → `backlog/done/2026Q2.md`（含 T-0095/T-0098/T-0101..T-0112/T-0099/T-0097/T-0030 + T-0115/T-0114/T-0116 + T-0113 + T-0090 全系列 + T-0096 + T-0102-a + T-0101 umbrella + T-0093 backup SFTP/FTPS + T-0102-b 真入队 + T-0102-c 真 RPC 派发 + T-0102-d/e MML 多帧 SSE + per-device 超时/重试/限流 + **+T-0117 登录非 secure context fail-fast + Login page App.useApp() scoped message 2026-05-12（修复 http://内网IP:8081 部署下 crypto.subtle undefined 导致 /auth/login 永不发出的诡异 bug）**）|
