...
| `done` | 135 | — | 详细 Closing Evidence → `backlog/done/2026Q2.md`（含 T-0095/T-0098/T-0101..T-0112/T-0099/T-0097/T-0030 + T-0115 CSV export MVP + **+T-0114 F10 fault-inject category MVP 2026-05-11（commit 0f7b7aa9）+ T-0116 F10 设备型号矩阵 TargetDeviceModels filter MVP 2026-05-11（commit a67e87d8）**）|
...
| `triaged` | 5 | — | T-0091 / T-0093 (backup 外部 trigger) / T-0035 (XL 待 S2 拆) / T-0096 (deps T-0090 跟随) / T-0113 (F06 ops 合规债清账) — T-0114/T-0115/T-0116 三 F10 Phase 3 task 全 done MVP 2026-05-11 单晚 |
| `blocked` | 0 | ≤ 3 | — |
| `proposed` 积压天数 | 0 | ≤ 7 | — |
