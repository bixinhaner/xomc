...
- Background: `#0f1011` (Panel Dark), sticky at top, `border-bottom: 1px solid rgba(255,255,255,0.05)`
- Height: 56px (desktop), 48px (mobile)
- Content max-width: 1200px, centered, horizontal padding: 24px (desktop), 16px (mobile)
- Layout: flex, `justify-content: space-between`, `align-items: center`

**Logo Area (Left)**
- Logomark + wordmark left-aligned, `gap: 10px`
- Logomark: 20×20px SVG, `color: #f7f8f8`
- Wordmark: Inter Variable 15px weight 590, `color: #f7f8f8`, `letter-spacing: -0.165px`
- Divider after wordmark: `1px solid rgba(255,255,255,0.08)`, height 16px

**Nav Links (Center)**
- Horizontal list, `gap: 4px`
- Links: Inter Variable 13px weight 510, `color: #8a8f98`, `letter-spacing: -0.13px`
- Hover: `color: #d0d6e0`, background `rgba(255,255,255,0.04)`, `border-radius: 6px`, transition 150ms
- Active: `color: #f7f8f8`
- Padding per link: `6px 10px`
- Underline style: none (no bottom border indicators)

**CTA Area (Right)**
- Primary CTA: Brand Indigo button (`#5e6ad2` bg, `#fff` text, 6px radius, `8px 16px` padding, 13px weight 510)
- Secondary: Ghost button (`rgba(255,255,255,0.02)` bg, `1px solid rgba(255,255,255,0.08)` border, 6px radius)
- Hover CTA: `#828fff` background shift

**Sidebar Navigation (App)**
- Background: `#0f1011`, width: 240px (expanded), 48px (collapsed)
- Border-right: `1px solid rgba(255,255,255,0.05)`
- Section headers: Inter Variable 11px weight 510, `color: #62666d`, `text-transform: uppercase`, `letter-spacing: 0.05em`
- Nav items: Inter Variable 13px weight 400, `color: #8a8f98`, `padding: 6px 12px`, `border-radius: 6px`
- Nav items hover: `color: #d0d6e0`, `background: rgba(255,255,255,0.04)`
- Nav items active: `color: #f7f8f8`, `background: rgba(255,255,255,0.06)`, weight 510
- Icon + label: icon 16px, gap 8px, icon color matches text
- Collapse toggle: bottom of sidebar, icon-only mode shows tooltip on hover

**Search / Command Palette**
- Trigger: `Cmd+K` or `/`, icon button with search icon, `rgba(255,255,255,0.03)` bg
- Palette: `#191a1b` bg, `1px solid rgba(255,255,255,0.08)` border, 12px radius, multi-layer shadow
- Input: 16px Inter Variable weight 400, `#f7f8f8` text, placeholder `#62666d`
- Results: 13px weight 510 labels `#d0d6e0`, 12px metadata `#62666d`
- Group headers: 11px weight 510, `#62666d`, uppercase

**Breadcrumbs**
- Separator: `/` in `#62666d`
- Crumb: Inter Variable 13px weight 400, `color: #8a8f98`
- Current crumb: weight 510, `color: #d0d6e0`
- Hover: `color: #f7f8f8`

**Mobile Adaptation**
- Top nav: hamburger icon (left) + logo (center) + CTA (right)
- Sidebar: off-canvas drawer, slides from left, overlay `rgba(0,0,0,0.85)`
- Nav links: stacked vertically, full-width touch targets, `padding: 12px 16px`
- Breakpoint: collapse at 768px
