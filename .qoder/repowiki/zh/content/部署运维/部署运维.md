...
- [internal/backup/handler_test.go](file://omcgo/internal/backup/handler_test.go)
- [internal/backup/executor_test.go](file://omcgo/internal/backup/executor_test.go)
- [internal/backup/service......](file://omcgo/internal/backup/service_test.go)
</cite>
...
- 运行与日志
  - 日志输出路径统一配置为JSON格式并写入容器内日志目录，宿主机映射到/data/logs/omcgo。
...
章节来源
- [docker-compose.yml:13-17](file://omcgo/deployments/docker/docker-compose.yml#L13-L17)
...
## 结论
本部署运维文档基于仓库现有配置与代码实现，给出了从Docker到Kubernetes的完整落地方案，明确了监控告警、备份恢复、日志管理与性能调优的关键实践。建议在生产环境中进一步完善安全基线、密钥轮换、备份演练与容量规划，并持续优化HPA/KEDA策略与指标体系。
