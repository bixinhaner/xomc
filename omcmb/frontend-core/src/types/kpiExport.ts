...
/** 导出来源：dashboard 后端保留来源 / device_view 设备性能查看 / kpi_query 指标查询页 / pm_dashboard 性能仪表盘 / adhoc_result 自定义聚合任务结果。 */
export type KpiExportSource = 'dashboard' | 'device_view' | 'kpi_query' | 'pm_dashboard' | 'adhoc_result';
