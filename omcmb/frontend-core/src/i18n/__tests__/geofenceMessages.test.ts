...
const requiredKeys = [
  ...
  'geofence.action.deleteRequiresDisable',
  'geofence.action.bindDevices',
  'geofence.policy.exitAction',
  'geofence.policy.notifyOnlyDescription',
  'geofence.policy.deactivateDescription',
  'geofence.policy.legacyManualReviewWarning',
  'geofence.validation.exitActionRequired',
  ...
  'geofence.validation.nameInvalid',
  'geofence.validation.nameDuplicate',
  'geofence.lifecycle.activeJobsBlockArchive',
  'geofence.audit.archive',
