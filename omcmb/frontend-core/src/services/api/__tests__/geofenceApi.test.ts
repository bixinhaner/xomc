  ...
  it('maps durable control action readback instead of generic task completion', async () => {
    getMock.mockResolvedValue({
      data: [{
        ...
        contract_version: 2,
        before_state: [{ path: 'rf', value: '1', role: 'rf' }],
        requested_state: [{ path: 'rf', value: '0', role: 'rf' }],
        terminal_state: [{ path: 'op', value: '0', role: 'op_state' }],
        verified_state: [{ path: 'rf', value: '1', role: 'rf' }],
    ...
    expect(actions).toEqual([expect.objectContaining({
      ...
      status: 'partial_failed',
      contractVersion: 2,
      requestedState: [{ path: 'rf', value: '0', role: 'rf' }],
      terminalState: [{ path: 'op', value: '0', role: 'op_state' }],
      verifiedState: [{ path: 'rf', value: '1', role: 'rf' }],
