...
export const mockAlarmDefinitions: AlarmDefinition[] = [
  {
    ...
    cnSuggestion: '检查异常进程并确认 CPU 负载趋势。',
    enSuggestion: 'Check abnormal processes and verify the CPU load trend.',
    isShow: true,
    isUnknown: false,
  },
  {
    ...
    cnSuggestion: '检查射频链路与小区运行状态。',
    enSuggestion: 'Check the RF link and cell operational state.',
    isShow: true,
    isUnknown: false,
  },
  {
