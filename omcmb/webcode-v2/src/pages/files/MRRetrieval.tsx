...
// ============================================================
// MR 文件获取（对齐 v1 file/mr-retrieval）
//   按设备聚合的 MR 文件视图（useMRFileDevices）：基站 / 产品类 / 文件数 / 上报状态
//   行 → MR 文件详情 /files/mr-detail/:sn（按设备查看具体 MRO/MRS/MRE 文件）
...
export default function MRRetrieval() {
  ...
  return (
    <PageShell
      title="MR 文件获取"
      description="按设备聚合的 MRO/MRS/MRE 测量报告文件"
    >
