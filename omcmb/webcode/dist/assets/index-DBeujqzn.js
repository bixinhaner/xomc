import{u as j,j as a}from"./index-B06tlvel.js";import{r as i}from"./vendor-react-CRJBtj-N.js";import{D as T}from"./index-CcpZAyR-.js";import{F as S}from"./index-z0oIf0-W.js";import{L as w}from"./ListPageLayout-kMfTdzqk.js";import{T as N,j as u,B as L,L as B,D as I,g as k}from"./vendor-antd-DqeuePrm.js";const{Text:s,Paragraph:y,Title:g}=N,A=[{id:"1",alarmCode:"ALM-0001",alarmName:"CPU占用率超阈值",severity:"major",neType:"eNB",vendor:"华为",possibleCauses:`1. 系统负载过高
2. 进程异常死循环
...
`).map((l,t)=>a.jsx(y,{style:{margin:"2px 0",fontSize:13},children:l},t))})]})]})})]})}export{F as default};
