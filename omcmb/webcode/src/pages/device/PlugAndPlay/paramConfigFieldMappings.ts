...
export const GNB_SHEET_FIELD_MAPPINGS: readonly ParamConfigSheetFieldMapping[] = [
  ...
  { field: 'RFEnable', sheet: 'CELL', header: 'RF Enable' },
  ...
  { field: 'SyncSource', sheet: '1588_CONFIGURATION', header: 'Sync Source' },
  { field: 'ForcedSync', sheet: '1588_CONFIGURATION', header: 'Forced Sync' },
  { field: 'PTPProfile', sheet: '1588_CONFIGURATION', header: 'Profile' },
  { field: 'PTPDomain', sheet: '1588_CONFIGURATION', header: 'Domain' },
  { field: 'PTPTransmode', sheet: '1588_CONFIGURATION', header: 'Transmission Mode' },
  { field: 'PTPInterface', sheet: '1588_CONFIGURATION', header: 'Interface' },
  { field: 'PTPUnicastMode', sheet: '1588_CONFIGURATION', header: 'Unicast Mode' },
  { field: 'PTPSyncInterval', sheet: '1588_CONFIGURATION', header: 'Sync Interval' },
  { field: 'PTPDelayInterval', sheet: '1588_CONFIGURATION', header: 'Delay Interval' },
