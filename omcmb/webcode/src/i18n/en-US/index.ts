const messages: Record<string, string> = {
  ...
  // Device labels
  // -------------------------------------------------------------------------
  'device.group.basic':        'Basic Information',
  'device.group.enbGnbShared': 'eNB/gNB Shared',
  'device.group.enbOnly':      'eNB Only',
  'device.group.gnbOnly':      'gNB Only',
  'device.group.gsmOnly':      'GSM Only',
