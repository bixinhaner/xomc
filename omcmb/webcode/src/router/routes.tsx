...
const AlarmEmailSubscriptions = React.lazy(() => import('@/pages/alarm/AlarmEmailSubscriptions'));
...
export const routes: RouteObject[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'alarm/email-subscriptions', element: withSuspense(AlarmEmailSubscriptions) },
