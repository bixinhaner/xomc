...
export const deviceService = {
  ...
  async getGroups() {
    ...
    return [
      ...
      // 自定义设备组
      { id: 'grp-custom-1', name: 'VIP客户设备组', parentId: null, deviceCount: 8, description: 'VIP客户专属设备', builtIn: 0 },
      { id: 'grp-custom-2', name: '测试设备组', parentId: null, deviceCount: 5, description: '测试环境设备', builtIn: 0 },
      { id: 'grp-custom-3', name: '临时监控组', parentId: null, deviceCount: 3, description: '临时监控的设备', builtIn: 0 },
    ];
  },
