...
<html>
    <head>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				var time_zone = -1 * new Date().getTimezoneOffset();
    ...
    <body class="loginbody">
		...
		<div class="loginmain">
			<!-- <div class="loginlogo">北京融昱信息技术有限公司</div> -->
			<div class="loginformbox">
				<form id="loginfrom" action="${ctx }/sys/login/userLoad.htm" method="post" style="width: 100%; height: 100%; text-align: center; padding-right: 5px;"> 
					...
					<div class="login_user_div">
						...
						<input type="text" id="uid" class="input_" name="userInfo.usercode" value="${userInfo.usercode}" placeholder="<%=rb.getString("YongHuMingCheng")%>" 
					...
					<div class="login_pwd_div">
						...
						<input id="password" type="password" class="input_" name="userInfo.password" placeholder="<%=rb.getString("MiMa")%>" 
					...
					<p style="margin-left:25px;width: 220px">
