...
<ul id="paramNodesUl" class="paramNodesUl">
	...
	<%-- <li>
		...
		<input readonly id="LTE_NEIGH_LIST_LTE_CELL_PLMNID_name" name="LTE_NEIGH_LIST_LTE_CELL_PLMNID" title="${LTE_NEIGH_LIST_LTE_CELL_PLMNID_title }" class="border border-box" 
			min_length="5" max_length="6" onblur="validateMaxAndMinLength(event);validateSpecialChar(event);createMML();" js_regex="/^\d+$/"/>
		<div id="LTE_NEIGH_LIST_LTE_CELL_PLMNID_name_err" class="errSpan" style="display: block;margin-top: 5px;margin-left: 200px;">
			${LTE_NEIGH_LIST_LTE_CELL_PLMNID_title }
		</div>
	</li>
	<li>
		<label for="LTE_NEIGH_LIST_LTE_CELL_CID_name">${LTE_NEIGH_LIST_LTE_CELL_CID_name }</label>
		<input readonly id="LTE_NEIGH_LIST_LTE_CELL_CID_name" name="LTE_NEIGH_LIST_LTE_CELL_CID" type="text" min_value="0" max_value="268435455" 
			onblur="validateMaxAndMinVal(event);createMML();" class="border border-box" title="${LTE_NEIGH_LIST_LTE_CELL_CID_title }"/>
		<div id="LTE_NEIGH_LIST_LTE_CELL_CID_name_err" class="errSpan" style="display: block;margin-top: 5px;margin-left: 200px;">
			${LTE_NEIGH_LIST_LTE_CELL_CID_title }
		</div>
	</li> --%>
	<li>
		...
		<input id="LTE_NEIGH_LIST_LTE_CELL_EARFCN_name" name="LTE_NEIGH_LIST_LTE_CELL_EARFCN" type="text" min_value="0" max_value="65535" 
			onblur="validateMaxAndMinVal(event);createMML();" class="border border-box" title="${LTE_NEIGH_LIST_LTE_CELL_EARFCN_title }"/>
		<div id="LTE_NEIGH_LIST_LTE_CELL_EARFCN_name_err" class="errSpan" style="display: block;margin-top: 5px;margin-left: 200px;">
			${LTE_NEIGH_LIST_LTE_CELL_EARFCN_title }
		</div>
	</li>
	<li>
		...
		<input id="LTE_NEIGH_LIST_LTE_CELL_PHY_CELLID_name" name="LTE_NEIGH_LIST_LTE_CELL_PHY_CELLID" type="text" min_value="0" max_value="503" 
			onblur="validateMaxAndMinVal(event);createMML();" class="border border-box" title="${LTE_NEIGH_LIST_LTE_CELL_PHY_CELLID_title }"/>
		<div id="LTE_NEIGH_LIST_LTE_CELL_PHY_CELLID_name_err" class="errSpan" style="display: block;margin-top: 5px;margin-left: 200px;">
			${LTE_NEIGH_LIST_LTE_CELL_PHY_CELLID_title }
		</div>
	</li>
	<li>
		...
		<input id="LTE_X_BAICELLS_NEIGH_LIST_LTE_CELL_TAC_name" name="LTE_X_BAICELLS_NEIGH_LIST_LTE_CELL_TAC" type="text" min_value="0" max_value="65535" 
			onblur="validateMaxAndMinVal(event);createMML();" class="border border-box" title="${LTE_X_BAICELLS_NEIGH_LIST_LTE_CELL_TAC_title }"/>
		<div id="LTE_X_BAICELLS_NEIGH_LIST_LTE_CELL_TAC_name_err" class="errSpan" style="display: block;margin-top: 5px;margin-left: 200px;">
			${LTE_X_BAICELLS_NEIGH_LIST_LTE_CELL_TAC_title }
		</div>
	</li>
	<li> 
		<label for="LTE_NEIGH_LIST_LTE_CELL_QOFFSET_name">${LTE_NEIGH_LIST_LTE_CELL_QOFFSET_name }</label>
		<select id="LTE_NEIGH_LIST_LTE_CELL_QOFFSET_name" name="LTE_NEIGH_LIST_LTE_CELL_QOFFSET" class="border border-box" onblur="createMML();">
			<option value=""></option>
	...
	<li> 
		...
		<select id="LTE_NEIGH_LIST_LTE_CELL_CIO_name" name="LTE_NEIGH_LIST_LTE_CELL_CIO" class="border border-box" onblur="createMML();">
			<option value=""></option>
			<option value="-24">-24</option>
			<option value="-22">-22</option>
			<option value="-20">-20</option>
