...
<div id="deviceMgmt" class="panelDefault" style="overflow:hidden;">
	...
	<div class="deviceList">
		...
		<el-ctable ref="ctableDevice" :url="deviceUrl" :height="height" :row-key="tableRowKey" :query-params="params_device" id="cpeOrEnbDeviceTable" 
			...
			<el-table-column v-if="enbFlag == 'true'" label='<%=rb.getString("XiaoZhanBianMa")%>' min-width="140" prop="serial_number"></el-table-column>
			<el-table-column v-if="enbFlag == 'true'" label='<%=rb.getString("HostName")%>' min-width="100" prop="host_name"></el-table-column>
			<el-table-column v-if="enbFlag == 'true'" label='<%=rb.getString("MACDiZhi")%>' min-width="130" prop="mac_address"></el-table-column>
			<el-table-column v-if="enbFlag == 'true'" label='<%=rb.getString("SheBeiZuMingCheng")%>' min-width="100" prop="group_name"></el-table-column>
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol !=='true'" label='<%=rb.getString("ChangShang")%>' min-width="100" prop="manufacturer"></el-table-column>
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol !=='true'" label='<%=rb.getString("ChengShi")%>' min-width="100" prop="city"></el-table-column>
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol !=='true'" label='<%=rb.getString("SuoShuZhiJu")%>' min-width="100" prop="sub_branches"></el-table-column>
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol !=='true'" :label="siteNameLabel" min-width="100" prop="sub_station_name"></el-table-column>
			
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol =='true'" :label="siteNameLabel" min-width="140" prop="sub_station_name"></el-table-column>
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol =='true'" label='<%=rb.getString("AnZhuangXiangXiDiZhi")%>' min-width="200" prop="install_address"></el-table-column>
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol =='true'" label='<%=rb.getString("YeZhuLianXiFangShi")%>' min-width="100" prop="contact_number"></el-table-column>
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol =='true'" :label="siteIdLabel" min-width="100" prop="site_id"></el-table-column>
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol =='true'" label='Circuit Ref.' min-width="100" prop="circuit_ref"></el-table-column>
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol =='true'" label='Circuit J & O' min-width="100" prop="circuit_jo"></el-table-column>
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol =='true'" label='Status' min-width="100" prop="service_status"></el-table-column>
			<el-table-column v-if="enbFlag == 'true' && showOrHideCol =='true'" label='Rom' min-width="100" prop="rom"></el-table-column>
	...
	<el-dialog title='<%=rb.getString("XiuGai")%>' :visible.sync="showModifyDevice" ref="modifyDialog" :width="windowWidth"
		...
		<el-form ref="modifyForm" label-position="top" :model="deviceForm" :rules="deviceRules" style="max-height: 500px;overflow: auto;">
			<el-form-item v-show="enbFlag == 'true'" class="max-width-45">
				<%=rb.getString("XiaoZhanBianMa")%><%=rb.getString("MaoHao")%> {{deviceName}}
			</el-form-item>
			<el-form-item v-show="enbFlag == 'false'" class="max-width-45">
				<%=rb.getString("MACDiZhi")%><%=rb.getString("MaoHao")%> {{deviceName}}
			</el-form-item>
			<el-form-item label="<%=rb.getString("JingDu")%>" prop="gps_longitude" class="max-width-45">
				<el-input v-model="deviceForm.gps_longitude"></el-input>
			</el-form-item>
			<el-form-item label="<%=rb.getString("WeiDu")%>" prop="gps_latitude" class="max-width-45">
				<el-input v-model="deviceForm.gps_latitude"></el-input>
			</el-form-item>
			<el-form-item label="<%=rb.getString("GaoDu")%>" prop="height" class="max-width-45">
				<el-input v-model="deviceForm.height"></el-input>
			</el-form-item>
			<el-form-item v-show="enbFlag == 'false'" label="<%=rb.getString("JuLi")%>" prop="distance" class="max-width-45">
				<el-input v-model="deviceForm.distance"></el-input>
			</el-form-item>
			
			<div v-show="enbFlag == 'true'" style="margin-bottom:10px;">
				<div v-show='showOrHideCol !=="true"'>
					<el-form-item label="<%=rb.getString("ShengChanChangJia")%>" class="max-width-45">
						<el-input v-model="deviceForm.manufacturer" maxLength="45"><el-input>
					</el-form-item> 
					<el-form-item label="<%=rb.getString("SheBeiXingHao")%>" class="max-width-45">
						<el-input v-model="deviceForm.module_type" maxLength="45"><el-input>
					</el-form-item> 
					<el-form-item label="<%=rb.getString("HostName")%>" class="max-width-45">
						<el-input v-model="deviceForm.host_name" maxLength="50"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("Sheng")%>" class="max-width-45">
						<el-input v-model="deviceForm.province" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("ChengShi")%>" class="max-width-45">
						<el-input v-model="deviceForm.city" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("XianQu")%>" class="max-width-45">
						<el-input v-model="deviceForm.district" maxLength="128"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("XiangZhen")%>" class="max-width-45">
						<el-input v-model="deviceForm.township" maxLength="128"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("SuoShuWangGe")%>" class="max-width-45">
						<el-input v-model="deviceForm.sub_grid" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("SuoShuZhiJu")%>" class="max-width-45">
						<el-input v-model="deviceForm.sub_branches" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("ZhanZhiBianMa")%>" class="max-width-45">
						<el-input v-model="deviceForm.sub_station_code" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item :label="siteNameLabel" class="max-width-45">
						<el-input v-model="deviceForm.sub_station_name" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("FenBuXiTong")%>" class="max-width-45">
						<el-input v-model="deviceForm.sub_distribute_system" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("SuoShuENBBiaoShi")%>" class="max-width-45">
						<el-input v-model="deviceForm.sub_cell_id" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("SuoShuENBMingCheng")%>" class="max-width-45">
						<el-input v-model="deviceForm.sub_cell_name" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("SuoShuTAList")%>" class="max-width-45">
						<el-input v-model="deviceForm.sub_talist" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("FuGaiChangJingShuXing")%>" class="max-width-45">
						<el-input v-model="deviceForm.over_scen_attr" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("SheBeiGongLv")%>" class="max-width-45">
						<el-input v-model="deviceForm.maxtxpower" maxLength="45"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("SheBeiJieRuFangShi")%>" class="max-width-45">
						<el-input v-model="deviceForm.device_access_mode" maxLength="32"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("RXDuanKouShu")%>" class="max-width-45">
						<el-input v-model="deviceForm.rx_port_number" maxLength="11"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("TXDuanKouShu")%>" class="max-width-45">
						<el-input v-model="deviceForm.tx_port_number" maxLength="11"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("WangGuanIP")%>" prop="omc_ip" class="max-width-45">
						<el-input v-model="deviceForm.omc_ip" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("SheBeiIP")%>" prop="cell_ip" class="max-width-45">
						<el-input v-model="deviceForm.cell_ip" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("TAC")%>" prop="tac" class="max-width-45">
						<el-input v-model="deviceForm.tac" maxLength="200"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("RuanJianBanBen")%>" class="max-width-45">
						<el-input v-model="deviceForm.software_version" maxLength="500"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("WangYuanDengJi")%>" class="max-width-45">
						<el-input v-model="deviceForm.net_grade" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("AnZhuangXiangXiDiZhi")%>" class="max-width-45">
						<el-input v-model="deviceForm.install_address" maxLength="256"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("RuWangShiJian")%>" class="max-width-45">
						<el-date-picker v-model="deviceForm.access_net_date" type="datetime" :editable="false" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
					</el-form-item>
					<el-form-item label="<%=rb.getString("DaiWeiDuiWuHao")%>" class="max-width-45">
						<el-input v-model="deviceForm.agent_maintain" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("YeZhuLianXiRen")%>" class="max-width-45">
						<el-input v-model="deviceForm.contact_person" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("YeZhuLianXiFangShi")%>" class="max-width-45">
						<el-input v-model="deviceForm.contact_number" maxLength="64"><el-input>
					</el-form-item>
					<el-form-item label="<%=rb.getString("SheBeiZhuangTai")%>" class="max-width-45">
						<el-select v-model='deviceForm.device_status'>
					...
					<el-form-item label="<%=rb.getString("ShangLianKuanDaiZhangHu")%>" class="max-width-45">
						<el-input v-model="deviceForm.uplink_broadband_account" maxLength="64"><el-input>
					</el-form-item>
				</div>
				...
				<div v-show="showOrHideCol == 'true'">
					...
					<el-form-item :label="siteIdLabel" class="max-width-45">
						<el-input v-model="deviceForm.site_id" maxLength="256"><el-input>
					</el-form-item>
					<el-form-item label="Circuit Ref." class="max-width-45">
						<el-input v-model="deviceForm.circuit_ref" maxLength="128"><el-input>
					</el-form-item>
					<el-form-item label="Circuit J & O" class="max-width-45">
						<el-input v-model="deviceForm.circuit_jo" maxLength="128"><el-input>
					</el-form-item>
					<el-form-item label="Status" class="max-width-45">
						<el-input v-model="deviceForm.service_status" maxLength="50"><el-input>
					</el-form-item>
					<el-form-item label="Rom" class="max-width-45">
						<el-input v-model="deviceForm.rom" maxLength="50"><el-input>
					</el-form-item>
				</div>
	...
	<el-dialog title="<%=rb.getString("QueRen")%>" :visible.sync="showDeviceGroupInfo" width="400" 
		...
		<div style="font-size:12px;color:#999999;padding-top:8px;"><%=rb.getString("ZuNeiSheBeiHuiBeiZiDongYiDongDaoMoRenFenZu")%></div>
	...
	data(){
		...
		*/ 
		var lessThenLength = function(str,num){
			...
			validOMCIP = function(rule,value,cb) {
			...
			validTAC = function(rule,value,cb) {
				...
				if ((val && !reg.test(val)) || (val < 0 || val > 65535)) {
					cb('Integer, 0-65535');
				}else{
					cb();
				}
		...
		return {
			...
			//uploadFileURL: '${ deviceType == 'eNB' }' == 'true'? '${ctx}/system/deviceGroup/uploadFile.action':'${ctx}/cell/CPE/uploadFile.action?importType=append',
	...
	methods:{
		...
		*/
		...
		addDevice(){
		    ...
		    if( vm.enbFlag == 'true' ){
				vm.windowWidth = '1000px';
		    	vm.dialogUrl = "/system/deviceGroup/goDeviceGroupEnbPage.action";
		...
		*/ 
		modifyDevice(code) {
			...
			if(vm.deviceForm.device_status === '' || vm.deviceForm.device_status === null || vm.deviceForm.device_status === undefined){
				vm.deviceForm.device_status = 1;
			}
		},
		// 基站设备修改确定
		saveModifyDevice(){
			...
			Object.assign(params, vm.deviceForm);
			params.longitude = params.gps_longitude;
			params.latitude = params.gps_latitude;
		...
		*/ 
 		deleteDevice(code){
	    	...
	    	vm.$confirm('<%=rb.getString("QueDingShanChuSheBei")%>','<%=rb.getString("QueRen")%>',{
