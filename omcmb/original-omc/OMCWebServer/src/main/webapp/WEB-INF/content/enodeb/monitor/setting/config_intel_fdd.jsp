...
<style>
	...
	#intelFdd_compactParamConfig .itemDiv input,#intelFdd_compactParamConfig .itemDiv select{
		width:350px;
	}
	#intelFdd_compactParamConfig .itemDiv img{
		position:relative;
		top:4px;
		left:5px;
	}
...
<div id="intelFdd_compactParamConfig" class="inputInfos">
		...
		<div class="omcTabsPage logsTabsMainPage" style="left:20px;top:45px;overflow-x:hidden;overflow-y:auto;height:60vh;">
			...
			<div class="wirelessSetting" style="padding: 20px 0 0 20px;display:block">
				<div class="itemDiv">
					...
					<input id="LTE_CELL_ECI" type="text" name="LTE_CELL_ECI" class="border border-box item" oldValue="${CELL_IDENTITY}" value="${CELL_IDENTITY}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="0" max_value="268435455" 
					...
					<div class="errorTitle" id="LTE_CELL_ECI_err">int, min value: 0, max value: 268435455</div>
				</div>
				<div class="itemDiv">
					...
					<input type="text" name="LTE_HOME_NODEB_NAME" id="LTE_HOME_NODEB_NAME" class="border border-box item" oldValue="${HOST_NAME}" value="${HOST_NAME}"
							onblur="intelFdd_validateHostName(event)" max_length="48"
				...
				<div class="itemDiv" style="float:none;clear:both;height:77px">
					...
					<input type="text" name="LTE_SIGLINK_SERVER_LIST" id="LTE_SIGLINK_SERVER_LIST" class="border border-box item" 
						oldValue="" value="" onblur="intelFdd_validateIPAddress1(event)" 
						title="<%=rb.getString("QingShuRuYiGeYouXiaoDeIPDiZhi")%>" />
					<a onclick="intelFdd_addMMEIpInputText(this)">
				...
				<div class="itemDiv">
					...
					<input type="text" name="LTE_OAM_PLMNID" id="LTE_OAM_PLMNID" class="border border-box item" oldValue="${PLMNID}" value="${PLMNID}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="10000" max_value="999999"
							title="<%=rb.getString("PLMNTitle")%>"/>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>	
					<div class="errorTitle" id="LTE_OAM_PLMNID_err"><%=rb.getString("PLMNTitle")%></div>
				</div>
				<div class="itemDiv pciisLock">
					<c:if test="${isElfCell != 1}">
						<span title="<%=rb.getString("RSPCI")%>"><%=rb.getString("PCI2")%></span>
						<input type="text" name="LTE_PHY_CELLID_LIST" id="LTE_PHY_CELLID_LIST" class="border border-box item" oldValue="${PHYCELLID}" value="${PHYCELLID}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="0" max_value="503"
							title="int, min value: 0, max value: 503"/>
							<img src="${ctx}/skin/${manufacturer}/images/bi/pci_lock.png"/>
						<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
						<div class="errorTitle" id="LTE_PHY_CELLID_LIST_err">int, min value: 0, max value: 503</div>					
					</c:if>
					<c:if test="${isElfCell == 1}">
						<span title="<%=rb.getString("RSPCI")%>"><%=rb.getString("PCI2")%></span>
						<input type="text" name="LTE_PHY_CELLID_LIST" id="LTE_PHY_CELLID_LIST" class="border border-box item" oldValue="${PHYCELLID}" value="${PHYCELLID}"
							onblur="intelFdd_commonChangeTip(event)" 
				...
				<div class="itemDiv">
					...
					<input type="text" name="LTE_TAC"  id="LTE_TAC"class="border border-box item" oldValue="${TAC}" value="${TAC}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="0" max_value="65535"
							title="int, min value: 0, max value: 65535"/>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="LTE_TAC_err">int, min value: 0, max value: 65535</div>
				</div>
				<div class="itemDiv" style="display: none">
					<span title="<%=rb.getString("RSFrequencyBand")%>"><%=rb.getString("ZhiChiPinDuan")%></span>
					<input type="text" name="LTE_BANDS_SUPPORTED" id="LTE_BANDS_SUPPORTED" class="border border-box item" 
					 		oldValue="${BANDS_SUPPORTED}" value="${BANDS_SUPPORTED}" 
					 		onblur="intelFdd_commonChangeTip(event)" title="stringList-[1:62]"/>	
					<div class="errorTitle" id="LTE_BANDS_SUPPORTED_err">stringList-[1:62]</div>
				</div>
				<div class="itemDiv">
					<span title="<%=rb.getString("RSBandIndicator")%>"><%=rb.getString("PinDuan")%></span>
					<input type="text" name="LTE_FREQ_BAND_INDICATOR" id="LTE_FREQ_BAND_INDICATOR" class="border border-box item" 
					 oldValue="${FREQBAND_INDICATOR}" value="${FREQBAND_INDICATOR}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="1" max_value="65"
							title="int, min value: 1, max value: 65"/>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="LTE_FREQ_BAND_INDICATOR_err">int, min value: 1, max value: 65</div>
				</div>
				<div class="itemDiv">
					<span title="<%=rb.getString("XiaXingPinDian")%>"><%=rb.getString("XiaXingPinLv")%>(MHz)</span>
					<input type="text" name="LTE_DL_EARFCN" id="LTE_DL_EARFCN" class="border border-box item" oldValue="${EARFCNDLINUSE}" value="${EARFCNDLINUSE}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="0" max_value="3800"
							title="int, min value: 0, max value: 3800"/>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="LTE_DL_EARFCN_err">int, min value: 0, max value: 3800</div>
				</div>
				<div class="itemDiv">
					<span title="<%=rb.getString("ShangXingPinDian")%>"><%=rb.getString("ShangXingPinLv")%>(MHz)</span>
					<input type="text" name="LTE_UL_EARFCN" id="LTE_UL_EARFCN" class="border border-box item" oldValue="${EARFCNULINUSE}" value="${EARFCNULINUSE}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="0" max_value="3800"
							title="int, min value: 0, max value: 3800"/>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="LTE_UL_EARFCN_err">int, min value: 0, max value: 3800</div>
				</div>
				<%-- <div class="itemDiv pciisLock">
					<span title="<%=rb.getString("RSEarfcn")%>"><%=rb.getString("PinDian")%></span>
					<input type="text" name="LTE_UL_DL_EARFCN" id="LTE_UL_DL_EARFCN" class="border border-box item" oldValue="${EARFCNULINUSE}" value="${EARFCNULINUSE}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="0" max_value="65535"
							title="int, min value: 0, max value: 65535"/>					
						<img src="${ctx}/skin/${manufacturer}/images/bi/pci_lock.png"/>
				</div> --%>
				<%-- <div class="itemDiv">
					<span title="<%=rb.getString("tttt")%>"><%=rb.getString("ZuiDaFaSheGongLv")%></span>
					<input type="text" name="LTE_MAX_TX_POWER" readonly class="border border-box" style="width:250px;" 
					 oldValue="${MAXTXPOWER}" value="${MAXTXPOWER}"
							onblur="validateMaxAndMinVal(event)" min_value="0"
							title="int, min value: 0"/>
				</div> --%>
				<div class="itemDiv">
					<span title="PB"><%=rb.getString("WuXianDuanKouXinHaoGongLvBi")%></span>
					<select name="LTE_PB" id="LTE_PB" class="border border-box item" oldValue="${LTE_PB}" onchange="intelTddSelectChange(event)">
						<option value=""> </option>
					...
					<input type="hidden" value="" id="OLD_LTE_PB">
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
				</div>
				<div class="itemDiv" id="intelFddPowerModifyDiv">
					<span title="<%=rb.getString("GongLvDengJi")%>"><%=rb.getString("GongLvDengJi")%></span>
					<input name="LTE_CELL_POWER_MODIFY"  id="LTE_CELL_POWER_MODIFY" class="border border-box item" value="${CELL_POWER_MODIFY}" oldValue="${CELL_POWER_MODIFY}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="15" max_value="40" />
					<div class="errorTitle" id="LTE_CELL_POWER_MODIFY_err">int, min value: 15, max value: 40</div>
					<input type="hidden" value="" id="OLD_LTE_CELL_POWER_MODIFY">
				</div>
				<div class="itemDiv" style="display:none">
					<span title="<%=rb.getString("RSDLBandWidth")%>"><%=rb.getString("XiaXingDaiKuan")%></span>
					<select name="LTE_DL_BANDWIDTH"  id="LTE_DL_BANDWIDTH" class="border border-box item">
						<option value=""> </option>
					...
					<input type="hidden" value="" id="OLD_LTE_DL_BANDWIDTH">
				</div>
				<div class="itemDiv">
					<span title="<%=rb.getString("RSBandwidth")%>"><%=rb.getString("DaiKuan")%></span>
					<select name="LTE_UL_BANDWIDTH" id="LTE_UL_BANDWIDTH" class="border border-box item" oldValue="${UL_BANDWIDTH}">
						<option value=""> </option>
						<option value="n25">5MHz</option>
						<option value="n50">10MHz</option>
						<option value="n75">15MHz</option>
					...
					<input type="hidden" value="" id="OLD_LTE_UL_BANDWIDTH">
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
				</div>
			
				<div class="itemDiv" style="display:none">
					<span title="<%=rb.getString("RSRootSequenceIndex")%>"><%=rb.getString("GenXuLieSuoYin")%></span>
					<input type="text" name="LTE_SON_PRACH_ROOT_SEQUENCE_INDEX_LIST"  id="LTE_ROOT_SEQ_INDEX" class="border border-box item" 
						oldValue="${ROOT_SEQUENCE_INDEX}" value="${ROOT_SEQUENCE_INDEX}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="0" max_value="837"
							title="int, min value: 0, max value: 837"/>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="LTE_ROOT_SEQ_INDEX_err">int, min value: 0, max value: 837</div>
				</div>
			</div>
			<%-- 网络设置面板 --%>
			<div class="intentSetting" style="padding: 20px 0 0 20px;">
				...
				<div class="itemDiv staticDiv">
					...
					<input type="text" name="UNIT_IP_GATEWAY" id="UNIT_IP_GATEWAY"  class="border border-box staticItem"  oldValue="${GATE_WAY}"
					 		value="${GATE_WAY}" onblur="intelFdd_validateIPAddress1(event)" must="1"/>
				...
				<div class="itemDiv staticDiv">
					...
					<input type="text" name="UNIT_IP_ADDRESS_NEW" id="UNIT_IP_ADDRESS_NEW" class="border border-box staticItem"  oldValue="${CELL_IP_NEW}"
							value="${CELL_IP_NEW}" onblur="intelFdd_validateIPAddress1(event)" must="1"/>
				...
				<div class="itemDiv staticDiv">
					...
					<input type="text" name="UNIT_IP_NET_MASK"  id="UNIT_IP_NET_MASK" class="border border-box staticItem"  oldValue="${IP_NET_MASK}"
							value="${IP_NET_MASK}" onblur="intelFdd_validateIPAddress1(event)" must="1"/>
				...
				<div class="itemDiv staticDiv" style="display: none">
					...
					<input type="text" disabled="disabled" name="UNIT_IP_DNS1"  id="UNIT_IP_DNS1" class="border border-box staticItem"  value="114.114.114.114"/>
				</div>
				<div class="itemDiv staticDiv">
					<span><%=rb.getString("MoRenDNS")%></span>
					<input type="text" disabled="disabled" name="UNIT_IP_DNS2"  id="UNIT_IP_DNS2"class="border border-box staticItem"  value="8.8.8.8"/>
				</div>
				<div class="itemDiv staticDiv">
					...
					<input type="text" name="UNIT_IP_DNS"  id="UNIT_IP_DNS" class="border border-box staticItem" oldValue=""  
							onblur="intelFdd_validateIPAddress1(event)"/>
			...
			<div class="NTPSetting" style="padding: 20px 0 0 20px;">
				<div class="itemDiv" style="float:none;clear:both;">
					...
					<input type="text" name="LTE_X_BAICELLS_NTP_SYNC_INTERVAL" id="LTE_X_BAICELLS_NTP_SYNC_INTERVAL" class="border border-box item" oldValue="${X_BAICELLS_NTP_SYNC_INTERVAL}" value="${X_BAICELLS_NTP_SYNC_INTERVAL}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="10" max_value="65535"
				...
				<div class="itemDiv">
					...
					<input type="text" name="LTE_NTP_SERVER_1"  id="LTE_NTP_SERVER_1" class="border border-box item" oldValue="${NTP_SERVER_1}" value="${NTP_SERVER_1}"
							onblur="intelFdd_validateMaxAndMinLength1(event)" min_length="0" max_length="256"
				...
				<div class="itemDiv">
					...
					<input type="text" name="LTE_NTP_PORT_1"  id="LTE_NTP_PORT_1" class="border border-box item" oldValue="${NTP_PORT_1}" value="${NTP_PORT_1}"
							onblur="intelFdd_validateMaxAndMinVal1(event)" min_value="1" max_value="20000"
			...
			<%-- IPSEC设置 --%>
			<div class="IPSECSetting" style="padding: 20px 0 0 20px;display:none;" id="IPSECDIV">
		...
		<div class="windowButtonGroup" style="position:absolute;bottom:37px;left:47px;">
			<a class="easyui-linkbutton linkbutton linkbutton_trend" onclick="intelFdd_cellSettingCommit()"><span><%=rb.getString("QueDing")%></span></a>
...
<%-- 窗口-右键设置进度条 --%>
<div id="intelFdd_winSettingPro" title="<%=rb.getString("CanShuPeiZhiJinDu")%>" class="easyui-window"
...
$("select[name='LTE_UL_BANDWIDTH']").bind("change",function(){
	...
	var oldValue=$("#OLD_LTE_UL_BANDWIDTH").val();
	var ele = $(this);
	var oldValueText = "";
	...
	for(var i=0;i<opts.length;i++){
		if(opts[i].value == this.value){
			...
			if(oldValue!=this.value){
				$("#LTE_UL_BANDWIDTH").css({"color":"blue"});
				$("#LTE_UL_BANDWIDTH option").css({"color":"black"});
				/* $.map($("#LTE_UL_BANDWIDTH option:not(:selected)"),function(ele){
				...
				$("#LTE_UL_BANDWIDTH").css({"color":"black"});	
...
function intelFdd_authbyChange(e){
	var ele = $(e["target"]);
	...
	intelFdd_changeColor(ele.attr("id"));
}
...
$(function() {
	...
	//如果SAS开关打开，则该参数不可配置
	if(SASEnble == "1"){
		$("#LTE_DL_EARFCN,#LTE_UL_EARFCN").attr("disabled",true);
		$("#LTE_UL_BANDWIDTH").attr("disabled",true).css("background","#EAF1F4");
	}
	...
	$("#OLD_LTE_UL_BANDWIDTH").val("${UL_BANDWIDTH}");
	//$("#OLD_LTE_TDD_SUBFRAME_ASSIGNMENT").val("${SUBFRAME_ASSIGNMENT}");
	//$("#OLD_LTE_TDD_SPECIAL_SUB_FRAME_PATTERNS").val("${SPECIAL_SUBFRAME_PATTERNS}");

	
	$("#LTE_PB").val("${LTE_PB}");
	$("#OLD_LTE_PB").val("${LTE_PB}");
	if ("${LTE_CELL_POWER_MODIFY_LIST}" == "" && false) {
		$("#intelFddPowerModifyDiv").css("display", "none");
	} else {
		//获取可以修改的参数信号功率列表
		...
		if (powerModifyList.indexOf("[") > -1) {
			...
			for (var count = minNum; count <= minMax; count++) {
				...
				$("#LTE_CELL_POWER_MODIFY").append(opt);
			}
		} else {
			var opt = "<option value='"+powerModifyList+"' selected='selected'>"+powerModifyList+"</option>";
			
			$("#LTE_CELL_POWER_MODIFY").append(opt);
			$("#LTE_CELL_POWER_MODIFY").attr("disable", "disable");
		} */
		setTimeout(function(){
			$("#LTE_CELL_POWER_MODIFY").next().find('input:visible').attr("oldvalue","${CELL_POWER_MODIFY}");
		},0);
		$("#OLD_LTE_CELL_POWER_MODIFY").val("${CELL_POWER_MODIFY}");
	}
	...
	if(cellIpsecInfos.length==0){
		...
		for(var i=0;i<cellIpsecInfos.length;i++){
			...
			//创建ID文本框
			var IDDIV = intelFdd_createIpsecInputDiv('<%=rb.getString("SuoYin") %>',"ID_"+ID,ID,true);
			var TunnelMingChengDIV = intelFdd_createIpsecInputDiv('<%=rb.getString("TunnelMingCheng") %>',"TUNNEL_NAME_"+ID,cellIpsecInfos[i].TUNNEL_NAME);
			var TunnelWangGuanDIV = intelFdd_createIpsecInputDiv('<%=rb.getString("TunnelWangGuan") %>',"TUNNEL_GATEWAY_"+ID,cellIpsecInfos[i].TUNNEL_GATEWAY);
			var IpsecZiWangDIV = intelFdd_createIpsecInputDiv('<%=rb.getString("IpsecZiWang") %> ',"RIGHT_SUBNET_"+ID,cellIpsecInfos[i].RIGHT_SUBNET);
			var MuDiDuanBiaoJiFuDIV = intelFdd_createIpsecInputDiv('<%=rb.getString("MuDiDuanBiaoJiFu") %>',"RIGHT_IDENTIFIER_"+ID,cellIpsecInfos[i].RIGHT_IDENTIFIER);
			var RenZhengFangShiDIV =intelFdd_createIpsecSelectDiv({"psk":"psk","cert":"cert","aka_psk":"aka_psk","aka_cert":"aka_cert"},cellIpsecInfos[i].AUTHBY,'<%=rb.getString("RenZhengFangShi") %>',"AUTHBY_"+ID);
			var YuGongXiangMiYaoDIV = intelFdd_createIpsecInputPasswordDiv('<%=rb.getString("YuGongXiangMiYao") %>',"PRE_SHARED_KEY_"+ID,cellIpsecInfos[i].PRE_SHARED_KEY);
		...
		$("select[name^='AUTHBY']").change(intelFdd_authbyChange);
	}
		...
		if (mmeArr.length > 1) {
			...
			for(var count = 1; count < newMMEInputCount; count++) {
				...
				var $mmeInput = $("<input type='text' name='LTE_SIGLINK_SERVER_LIST' class='border border-box item' "
						+ "id='LTE_SIGLINK_SERVER_LIST_org_"+count+"' onblur='intelFdd_validateIPAddress11(event)' oldValue='" + mmeArr[count] + "' value='" + mmeArr[count] + "' style='margin-left:0px'></input>");
				var $mmeButtn = $("<a onclick='intelFdd_removeMMEIpInputText(this)' style='margin-left:3px'>" 
...
<%-- 关闭窗口 --%>
function intelFdd_closeSelfWin() {
	/* $("#winCellSettings").window("close"); */
	closeDefaultWindow();
}
<%-- 提交 --%>
function intelFdd_cellSettingCommit() {
	...
	$.post("${ctx}/cell/cpeinfos/getCellConnStatus.action", {"small_cell_code": cellCode}, function(data){
		...
		if(data["connStatus"] == "false") {
			...
			if ($("#intelFdd_compactParamConfig .item.err_border").length > 0) {
				return;
			}
			...
			if(selectProto == "static") {
				if ($("#intelFdd_compactParamConfig .staticItem.err_border").length > 0) {
					return;
				}
			}
			...
			$("#intelFdd_compactParamConfig .item,.lgwInput,.itemStatisticInput").each(function() {
				...
				if (isReboot(params) || lgwchange || icicreboot) {
					...
					if ("${noReboot}" == 1) {
						...
						$.messager.confirm("<%=rb.getString("QueRen")%>", promptInfo, function (r) {
				            if (r) {
				            	$("#intelFdd_winSettingPro").window("open");
				            	//请求修改参数
				    			$.post("${ctx}/cell/param/compactParamConfig.action", params, function(data) {
				    				$("#intelFdd_winSettingPro").window("close");
				    				if (data["success"]) {
				    					intelFdd_closeSelfWin();
...
var randomNum_fdd = 0;
//添加一个MME地址输入框
function intelFdd_addMMEIpInputText(e) {
	randomNum_fdd += 1;
	//添加新的输入框
	...
	var $mmeDiv = $("<div class='itemDiv'></div>");
	var $mmeInput = $("<input type='text' name='LTE_SIGLINK_SERVER_LIST' class='border border-box item' "
		 + "id='LTE_SIGLINK_SERVER_LIST_"+randomNum_fdd+"' onblur='intelFdd_validateIPAddress11(event)'  oldValue='' style='margin-left:0px'></input>");
	var $mmeButtn = $("<a onclick='intelFdd_removeMMEIpInputText(this)' style='margin-left:3px'>" 
			+ "<img src='${ctx}/skin/${manufacturer}/images/bi/setting_sub.png'/></a>");
	var $tip = $("<div class='promptTitle'><span><%=rb.getString("SheZhiCellId")%></span><span class='unmodiValue'></span></div>" + 
			"<div class='errorTitle' id='LTE_SIGLINK_SERVER_LIST_"+ randomNum_fdd +"_err'><%=rb.getString("QingShuRuYiGeYouXiaoDeIPDiZhi")%></div>");
	...
	$(e).attr("onclick", "intelFdd_addMMEIpInputText(this)");
}
//删除选中的MME地址输入框
function intelFdd_removeMMEIpInputText(e) {
	$(e).parent("div").remove();
...
function intelFdd_createIpsecInputDiv(name,filedName,value,disabled){
  /*   var mes = "\<\%=rb.getString(\'"+tip+"\')\%\>"; */ 
	if(disabled == true){
		...
		var div = "<div class='itemDiv'><span>"+name+"</span><input id='"+filedName+"' onblur='intelFdd_commonChangeTip(event)' type='text' name='"+filedName+"' class='border border-box item'  oldValue='"
	   +value+"' value='"+value+"'/></div>";
	}
	return $(div);
}

function intelFdd_createIpsecInputPasswordDiv(name,filedName,value,disabled){
	//var tip = intelFdd_createTitleForIpSec(filedName);
	if(disabled == true){
		var div = "<div class='itemDiv'><span>"+name+"</span><input type='password' name='"+filedName+"' class='border border-box item' oldValue='"
		+value+"' value='"+value+"' disabled='disabled'/></div>";
	}else{
		var div = "<div class='itemDiv'><span>"+name+"</span><input type='password' id='pw' onblur='intelFdd_commonChangeTip(event)' name='"+filedName+"' class='border border-box item'  oldValue='"
	   +value+"' value='"+value+"'/></div>";
	}
	return $(div);
}

function intelFdd_createIpsecSelectDiv(jsonOption,selectedValue,name,filedName){
	...
	var selectHtml="<select name='"+filedName+"' id='" + filedName + "' class='border border-box item'>"+opts+"</select>";
	if (!selectedValue) {
		selectedValue = "";
	}
...
function intelFdd_validateMaxAndMinLength1(e){
  	var ele = $(e["target"]);
    var currVal = ele.val();
    var oldValue = ele.attr("oldValue");
    if(currVal!=oldValue){
...
function intelFdd_validateHostName(e){
	var ele = $(e["target"]);
    var currVal = ele.val();
...
function intelFdd_validateIPAddress1(e){
  	var ele = $(e["target"]);
    ele.siblings(".promptTitle").hide();
    validateIPAddress(e);
    if(!$("#" + ele.attr("id") + "_err").is(':visible')){
...
function intelFdd_validateIPAddress11(e){
  	var ele = $(e["target"]);
    ele.siblings(".promptTitle").hide();
    validateIPAddress(e);
    if(!$("#" + ele.attr("id") + "_err").is(':visible')){
...
function intelFdd_commonChangeTip(e){
	var ele = $(e["target"]);
    ele.siblings(".promptTitle").hide();
	validateByRegex(e)
	if(!$("#" + ele.attr("id") + "_err").is(':visible')){
...
function intelFdd_changeColor(id){
	var opts = $("#"+id).find("option");
	var oldValue=$("#OLD_"+id).val();
	var nowValue = $("#"+id).val();
	for(var i=0;i<opts.length;i++){
...
<%--  function intelFdd_createTitleForIpSec(fieldName){
