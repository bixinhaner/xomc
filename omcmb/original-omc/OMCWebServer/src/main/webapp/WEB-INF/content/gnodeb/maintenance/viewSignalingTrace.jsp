...
<style>
	...
	#viewTracePageGnb .radioBox{
		border:1px solid #D1ECF5 !important;
		width:660px;
		padding:15px 0px 15px 0px;
	}
	#viewTracePageGnb .el-form-item__label{
		line-height:26px;
		width:140px;
		text-align:left;
	}
	#viewTracePageGnb .modeItem .el-radio{
		display:inline-block;
		margin-left:0px;
	} 
	#viewTracePageGnb .modeItem{
		margin-top:30px;
	}
	.alarmBottomLine{
	...
	#viewTracePageGnb .editButton i{
		font-size:14px !important;
	}
	#viewTracePageGnb .editButton span{
		font-size:12px;
	}
	.dialogStyle .el-icon-circle-info:before{
		color:#CFCFCF;
	}
	#viewTracePageGnb .el-pairgrid-title{
		top:-6px;
	}
	#viewTracePageGnb .deviceItem{
		display:inline-block;
		margin-right:60px;
	}
	#viewTracePageGnb .pairgrid-right .el-ctable-toolbar{
...
<div id="viewTracePageGnb" style="margin-top:20px;">
...
var traceGnbJson = '${signalingTraceProperties}';
var viewTraceVueGnb = new Vue({
	el:'#viewTracePageGnb',
	data(){
		return {
			ruleForm:{
	...
	methods:{ 
		init(type, row){
			...
			var traceEnbObj = JSON.parse(traceGnbJson);
