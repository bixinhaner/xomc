...
<style>
	...
	#cell3InfoPage .subInputCls .el-select>.el-input{
		width: 150px!important;
	}
	#cell3InfoPage .EnergySavingTypeSelectCls .el-select>.el-input{
		width: 110px!important;
	}
	#cell3InfoPage .specialItem .el-input__inner{
		width:110px !important;
	}
	#cell3InfoPage .specialItem .el-input-group__append{
		padding-left: 50px!important;
	}
	
</style>

<div id="cell3InfoPage">
...
var cell3InfoVue =  new Vue({
	...
	mounted(){
		...
		eventBus.$off('cell3-submit').$on('cell3-submit',this.cell3Submit);
	}
