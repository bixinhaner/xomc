	...
	<div style="display: flex;">
		<div id="oneMMEPool" style="max-width: 50%;">
			<li style="position: relative;height: auto;min-width: 260px;">
				<label for="mme1_ip_input">${LTE_X_BAICELLS_POOL_MME_LIST1_name }</label>
				<input id="mme1_ip_input" title="${LTE_X_BAICELLS_POOL_MME_LIST1_title }" class="border border-box" 
				...
				<input id="mme1_ip_hidden" type="hidden" name="LTE_X_BAICELLS_POOL_MME_LIST1" />
		    </li>
			<li>
				<div style="display: flex;">
					<div>
						<label for="mme1_select_control" style="max-width: 225px;min-width: 220px;">${LTE_X_BAICELLS_MMELIST_TUNNEL_MAP_name }</label>
						<select id="mme1_select_control" title="${LTE_X_BAICELLS_MMELIST_TUNNEL_MAP_title }" class="border border-box" disabled
							onblur="updateControlPlane(1)" js_regex="no_zh">
							<option value="Tunnel1:LTE_X_BAICELLS_POOL_MME_LIST1">Tunnel1</option>
							<option value="Tunnel2:LTE_X_BAICELLS_POOL_MME_LIST1">Tunnel2</option>
					...
					<div>
						...
						<select id="mme2_select_control" title="${LTE_X_BAICELLS_MMELIST_TUNNEL_MAP_title }" class="border border-box" disabled
							onblur="updateControlPlane(2);" js_regex="no_zh">
							<option value="Tunnel1:LTE_X_BAICELLS_POOL_MME_LIST2">Tunnel1</option>
							<option value="Tunnel2:LTE_X_BAICELLS_POOL_MME_LIST2">Tunnel2</option>
							<option value="" selected>--Unbound--</option>
						</select>
				...
				<input id="mme_control_hidden" type="hidden" name="LTE_X_BAICELLS_MMELIST_TUNNEL_MAP" />
		    </li>
			<c:if test='${hardwareVersion != "CR_B4860_SC4.0" && hardwareVersion != "CR_B4860_CA4.0" && hardwareVersion != "CR_B4860_DC4.0" && hardwareVersion != "CR_B4860_TC4.0" && hardwareVersion != "MLN_SC1.0" && hardwareVersion != "MLN_CA1.0" && hardwareVersion != "MLN_DC1.0"}'>
				<li>
					<label for="mme1_select_user" style="max-width: 225px;min-width: 220px;">${LTE_X_BAICELLS_MMELIST1_UP_ITF_name }</label>
					<select id="mme1_select_user" name="LTE_X_BAICELLS_MMELIST1_UP_ITF" title="${LTE_X_BAICELLS_MMELIST1_UP_ITF_title }" class="border border-box" disabled
		...
		<div id="twoMMEPool" style="display: block">
			<li style="position: relative;height: auto;min-width: 260px;">
				<label for="mme2_ip_input">${LTE_X_BAICELLS_POOL_MME_LIST2_name }</label>
				<input id="mme2_ip_input" name="LTE_X_BAICELLS_POOL_MME_LIST2" title="${LTE_X_BAICELLS_POOL_MME_LIST2_title }" class="border border-box" 
				...
				<div id="LTE_X_BAICELLS_POOL_MME_LIST1_name_err" class="errSpan" style="display: block;margin-top: 5px;">
					${LTE_SIGLINK_SERVER_LIST_title }
				</div>
			...
			<c:if test='${hardwareVersion != "CR_B4860_SC4.0" && hardwareVersion != "CR_B4860_CA4.0" && hardwareVersion != "CR_B4860_DC4.0" && hardwareVersion != "CR_B4860_TC4.0" && hardwareVersion != "MLN_SC1.0" && hardwareVersion != "MLN_CA1.0" && hardwareVersion != "MLN_DC1.0"}'>
				<li>
					<label for="mme2_select_user" style="max-width: 225px;min-width: 220px;">${LTE_X_BAICELLS_MMELIST2_UP_ITF_name }</label>
					<select id="mme2_select_user" name="LTE_X_BAICELLS_MMELIST2_UP_ITF" title="${LTE_X_BAICELLS_MMELIST2_UP_ITF_title }" class="border border-box" disabled
						onblur="createMML();" js_regex="no_zh">
						<option value="eth2">WAN(DefaultValue)</option>
						<option value="ipsec">ipsec</option>
					</select>
