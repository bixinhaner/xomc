...
<div id="caCertificate" class="cacertWarp">
	<div class='leftWarp commonWarp'>
		...
		<el-ctable ref="caCertsTable" :url="caCertsUrl" :query-params="caCretsParams" id="caCertTable" :page-size="pageSize" pagination="true" 
			:rownumber=true :row-key="'id'" style="width:100%" @selection-change='caBatchSelect' :limit="limitBatch">
			<template slot="toolbar">
				...
				<div class='toolbarHeadBtnBoxCls' style='margin: -10px 0 0 0;'>
	            	...
	            	<div class="selectBlukBoxCls">
	                	...
	                	<div v-if="hasLicenseRole" :class="caCertSelectData.length >0 ? 'headBtnItemCls' : 'headBtnItemCls headBtnItemDisCls'" @click="caCertsDeleteBatch" style='border-right: 0;'>
...
<script type="text/javascript">
	var caCertificatePageVue = new Vue({
	    el: '#caCertificate',
	    data() {
	    	var vm = this,
	    ...
	    methods: {
			...
			*/
            ...
            // 关闭 CA 证书页面
            closeCaSlider(){
            	certificateManageVue.$refs.slideCA.hide();
	        },
	    },
		computed:{
			limitBatch(){
