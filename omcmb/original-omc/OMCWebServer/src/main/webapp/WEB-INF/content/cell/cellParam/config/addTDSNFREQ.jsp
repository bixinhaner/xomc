...
<ul id="paramNodesUl" class="paramNodesUl">
	<li>
		...
		<input id="LTE_TDS_CDMA_UTRA_ARFCN_name" name="LTE_TDS_CDMA_UTRA_ARFCN" type="text" min_value="0" max_value="65535" must="1"
	...
	<li>
		...
		<input id="LTE_TDS_CDMA_QRX_LEV_MIN_name" name="LTE_TDS_CDMA_QRX_LEV_MIN" type="text" min_value="-60" max_value="-13"  must="1"
	...
	<li>
		...
		<input id="LTE_TDS_CDMA_CELL_RESEL_PRIOR_name" name="LTE_TDS_CDMA_CELL_RESEL_PRIOR" type="text" min_value="0" max_value="7"  must="1"
	...
	<li>
		...
		<input id="LTE_TDS_CDMA_THRESH_X_HIGH_name" name="LTE_TDS_CDMA_THRESH_X_HIGH" type="text" min_value="0" max_value="31"  must="1"
	...
	<li>
		...
		<input id="LTE_TDS_CDMA_THRESH_X_LOW_name" name="LTE_TDS_CDMA_THRESH_X_LOW" type="text" min_value="0" max_value="31"  must="1"
	...
	<li>
		...
		<input id="LTE_TDS_CDMA_PMAX_UTRA_name" name="LTE_TDS_CDMA_PMAX_UTRA" type="text" min_value="-50" max_value="33"  must="1"
	...
	<li>
		...
		<input id="LTE_TDS_CDMA_QOFFSET_UTRATDD_name" name="LTE_TDS_CDMA_QOFFSET_UTRATDD" type="text" min_value="-15" max_value="15"  must="1"
	...
	<li>
		...
		<select id="LTE_TDS_CDMA_UTRATDD_MODE_name" name="LTE_TDS_CDMA_UTRATDD_MODE" value="UTRA_TDD_128" class="border border-box" onblur="createMML();" must="1">
			<option value=""></option>
	...
	<li>
		...
		<select id="LTE_TDS_CDMA_FREQ_ENABLE_name" name="LTE_TDS_CDMA_FREQ_ENABLE" class="border border-box" onblur="createMML();" must="1">
			<option value=""></option>
