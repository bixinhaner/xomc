	...
	<div style="display: flex;">
		<div id="oneMMEPool" style="max-width: 50%;">
			<li style="position: relative;height: auto;min-width: 260px;">
				<label for="mme1_ip_input">${LTE_POOL_MME_LIST1_name }</label>
				<input id="mme1_ip_input" title="${LTE_POOL_MME_LIST1_title }" class="border border-box" 
				...
				<input id="mme1_ip_hidden" type="hidden" name="LTE_POOL_MME_LIST1" />
		    </li>
			<li>
				<div style="display: flex;">
					<div>
						<label for="mme1_select_control" style="max-width: 225px;min-width: 220px;">${LTE_MMELIST_TUNNEL_MAP_name }</label>
						<select id="mme1_select_control" title="${LTE_MMELIST_TUNNEL_MAP_title }" class="border border-box" disabled
							onblur="updateControlPlane(1)" js_regex="no_zh">
							<option value="tunnel1:LTE_POOL_MME_LIST1">Tunnel1</option>
							<option value="tunnel2:LTE_POOL_MME_LIST1">Tunnel2</option>
					...
					<div>
						...
						<select id="mme2_select_control" title="${LTE_MMELIST_TUNNEL_MAP_title }" class="border border-box" disabled
							onblur="updateControlPlane(2);" js_regex="no_zh">
							<option value="tunnel1:LTE_POOL_MME_LIST2">Tunnel1</option>
				...
				<input id="mme_control_hidden" type="hidden" name="LTE_MMELIST_TUNNEL_MAP" />
		    </li>
		</div>
		
		<div id="twoMMEPool" style="display: block">
			<li style="position: relative;height: auto;min-width: 260px;">
				<label for="mme2_ip_input">${LTE_POOL_MME_LIST2_name }</label>
				<input id="mme2_ip_input" name="LTE_POOL_MME_LIST2" title="${LTE_POOL_MME_LIST2_title }" class="border border-box" 
				...
				<div id="LTE_POOL_MME_LIST1_name_err" class="errSpan" style="display: block;margin-top: 5px;">
					${LTE_SIGLINK_SERVER_LIST_title }
				</div>
