...
<ul id="paramNodesUl" class="paramNodesUl">
    ...
    <li id="IMSI_SWITCH">
        <label for="LTE_LGW_IMSI_SWITCH_name">${LTE_LGW_IMSI_SWITCH_name }</label>
        <select id="LTE_LGW_IMSI_SWITCH_name" name="LTE_LGW_IMSI_SWITCH" class="border border-box" onblur="createMML();">
            <option value=""></option>
