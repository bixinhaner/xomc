...
<style>
	...
	#cell1InfoPage .subInputCls .el-select>.el-input{
		width: 150px!important;
	}
	#cell1InfoPage .EnergySavingTypeSelectCls .el-select>.el-input{
		width: 110px!important;
	}
	#cell1InfoPage .specialItem .el-input__inner{
		width:110px !important;
	}
	#cell1InfoPage .specialItem .el-input-group__append{
		padding-left: 50px!important;
	}
	
</style>

<div id="cell1InfoPage">
...
var cell1InfoVue =  new Vue({
	...
	mounted(){
		...
		eventBus.$off('cell1-submit').$on('cell1-submit',this.cell1Submit);
	}
