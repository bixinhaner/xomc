...
<div style="flex: 1 auto;overflow: auto; height: 100%;" id="ipsec_props_div">
	<div class="form-group" >
		...
		<div class="form-wrap">
			...
			<div class="form-item">
				...
				<div class="form-item-wrap">
					<input name="leftId" class="easyui-textbox" style="width: 300px;" 
						data-options="minlength:0,maxlength:48,onChange:ipsecOnchange,events:{blur:function(e){
							validIpsecInput(e.target);
						}}">
				</div>
			</div>
			...
			<div class="form-item">
				<label class="form-title">Left</label>
				<div class="form-item-wrap">
					<input name="leftIp" class="easyui-textbox" style="width: 300px;" 
						data-options="onChange:ipsecOnchange,events:{blur:function(e){
							validIpsecInput(e.target);
						}}">
				</div>
		...
		setTimeout(function(){
			...
			var ctn = $(el).parent().prev(),
				...
				cascade = {
					...
					'0-0':             { show: ['secretKey'],  hide: ['leftCert','rightSecretKey'] },
					'0-1':             { show: ['secretKey'],  hide: ['leftCert','rightSecretKey'] },
					'1-0':             { show: ['leftCert','secretKey','rightSecretKey'], hide: [] },
					'1-1':             { show: ['leftCert','secretKey'], hide: ['rightSecretKey'] },
					'2-0':             { show: ['secretKey','rightSecretKey'], hide: ['leftCert'] },
					'2-1':             { show: ['leftCert','secretKey'], hide: ['rightSecretKey'] },
					'2-2':             { show: [], hide: ['leftCert','secretKey','rightSecretKey'] },
					'0-2':             {show: [], hide: []},
					'1-2':             {show: [], hide: []}
				};
