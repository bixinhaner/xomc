...
<ul id="paramNodesUl" class="paramNodesUl">
	...
	<li>
		...
		<input id="TUNNEL_NAME_name" name="TUNNEL_NAME" title="${TUNNEL_NAME_title }" class="border border-box" min_length="1" max_length="14" 
			onblur="validateMaxAndMinLength(event);validateSpecialChar(event);createMML();" js_regex="/^\w+$/" must="1"/>
		<div id="TUNNEL_NAME_name_err" class="errSpan" style="margin-top: 5px;margin-left: 200px;">
			${TUNNEL_NAME_title }<%=rb.getString("DouHao") %><%=rb.getString("BiTian") %>
		</div>
	</li>
	<li>
		<label for="TUNNEL_GATEWAY_name">${TUNNEL_GATEWAY_name }</label>
		<input id="TUNNEL_GATEWAY_name" name="TUNNEL_GATEWAY" title="${TUNNEL_GATEWAY_title }" class="border border-box" min_length="0" max_length="256"
			onblur="validateMaxAndMinLength(event);validateSpecialChar(event);createMML();" js_regex="no_zh" must="1"/>
		<div id="TUNNEL_GATEWAY_name_err" class="errSpan" style="margin-top: 5px;margin-left: 200px;">
			${TUNNEL_GATEWAY_title }<%=rb.getString("DouHao") %><%=rb.getString("BiTian") %>
		</div>
	</li>
	<li>
	...
	<c:if test='${hardwareVersion == "EA4.0" || hardwareVersion == "EA4.0DUAL"}'>
		<li>
			...
			<input id="KEYLIFE_name" name="KEYLIFE" title="${KEYLIFE_title }" class="border border-box" 
				min_length="0" max_length="256" onblur="validateMaxAndMinLength(event);validateSpecialChar(event);validateKeylife(event);createMML();" js_regex="/^\d+[s|m|d]{1}$/"/>
		...
		<li>
			...
			<input id="IKELIFETIME_name" name="IKELIFETIME" title="${IKELIFETIME_title }" class="border border-box" 
				min_length="0" max_length="256" onblur="validateMaxAndMinLength(event);validateSpecialChar(event);validateIKElifeTime(event);createMML();" js_regex="/^\d+[s|m|d]{1}$/"/>
		...
		<li>
			...
			<input id="REKEYMARGIN_name" name="REKEYMARGIN" title="${REKEYMARGIN_title }" class="border border-box" 
				min_length="0" max_length="256" onblur="validateMaxAndMinLength(event);validateSpecialChar(event);ValidateMinTime(event);createMML();" js_regex="/^\d+[s|m|d]{1}$/"/>
