...
<style>
	...
	#mmepool_compactParamConfig .itemDiv input,#mmepool_compactParamConfig .itemDiv select{
		width:350px;
	}
	#mmepool_compactParamConfig .itemDiv img{
		position:relative;
		top:4px;
		left:5px;
	}
...
<!-- tab选项卡 -->
<div id="mmepool_compactParamConfig" class="inputInfos">
			<!-- 选项 -->
	<div class="omcPageTitleDiv omcLogLists">
		<ul class="omcPageTitleContainer titleTabsList">
			...
			<li style="display:none" tabtit="IPSECSetting" onclick="turnTabs(this)"><%=rb.getString("IpsecSheZhi")%></li>
			<c:if test="${lgw == 1}">
		...
		<div class="omcTabsPage logsTabsMainPage" style="left:20px;top:45px;overflow-x:hidden;overflow-y:auto;height:60vh;">
			...
			<div class="wirelessSetting" style="padding: 20px 0 0 20px;display:block">
				<div class="itemDiv">
					...
					<input id="mmepool_LTE_CELL_ECI" type="text" name="LTE_CELL_ECI" class="border border-box item" oldValue="${CELL_IDENTITY}" value="${CELL_IDENTITY}"
							onblur="mmepool_validateMaxAndMinVal1(event)" min_value="0" max_value="268435455" 
					...
					<div class="errorTitle" id="mmepool_LTE_CELL_ECI_err">int, min value: 0, max value: 268435455</div>
				</div>
				<div class="itemDiv">
					<span title="<%=rb.getString("RSCellName")%>"><%=rb.getString("HostName")%></span>
					<input type="text" name="LTE_HOME_NODEB_NAME" id="mmepool_LTE_HOME_NODEB_NAME" class="border border-box item" oldValue="${HOST_NAME}" value="${HOST_NAME}"
							onblur="mmepool_validateHostName(event)" max_length="48"
							title="<%=rb.getString("SheBeiMingChengGuiZe")%>"/>
					<div class="errorTitle" id="mmepool_LTE_HOME_NODEB_NAME_err"><%=rb.getString("SheBeiMingChengGuiZe")%></div>
				</div>
				<%-- <div class="itemDiv">
					...
					<input type="text" name="LTE_SIGLINK_SERVER_LIST" id="LTE_SIGLINK_SERVER_LIST" class="border border-box item" 
						oldValue="" value="" onblur="mmepool_validateIPAddress1(event)" />
					<a onclick="mmepool_addMMEIpInputText(this)">
				...
				<div class="itemDiv" style="float:none;clear:both">
					<span title="<%=rb.getString("RSMME")%>">MMEPOOL1</span>
					<input type="text" name="LTE_X_BAICELLS_POOL_MME_LIST1" id="mmepool_LTE_X_BAICELLS_POOL_MME_LIST1" class="border border-box item" 
						oldValue="" value="" onblur="mmepool_validateIPAddress1(event)" />
					<a onclick="mmepool_addMMEIpInputText(this,1)">
						<img src="${ctx}/skin/${manufacturer}/images/bi/setting_add.png"/>  
					</a>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="mmepool_LTE_X_BAICELLS_POOL_MME_LIST1_err"><%=rb.getString("QingShuRuYiGeYouXiaoDeIPDiZhi")%></div>
				</div>
				<div class="itemDiv" style="float:none;clear:both">
					<span title="<%=rb.getString("RSMME")%>">MMEPOOL2</span>
					<input type="text" name="LTE_X_BAICELLS_POOL_MME_LIST2" id="mmepool_LTE_X_BAICELLS_POOL_MME_LIST2" class="border border-box item" 
						oldValue="" value="" onblur="mmepool_validateIPAddress1(event)" />
					<a onclick="mmepool_addMMEIpInputText(this,2)">
						<img src="${ctx}/skin/${manufacturer}/images/bi/setting_add.png"/>  
					</a>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="mmepool_LTE_X_BAICELLS_POOL_MME_LIST2_err"><%=rb.getString("QingShuRuYiGeYouXiaoDeIPDiZhi")%></div>
				</div>
				
				<div class="itemDiv">
					<span title="<%=rb.getString("RSPLMN")%>"><%=rb.getString("PLMN")%></span>
					<input type="text" name="LTE_OAM_PLMNID" id="mmepool_LTE_OAM_PLMNID" class="border border-box item" oldValue="${PLMNID}" value="${PLMNID}"
							onblur="mmepool_validateMaxAndMinVal1(event)"  min_value="10000" max_value="999999" 
							title="<%=rb.getString("PLMNTitle")%>"/>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="mmepool_LTE_OAM_PLMNID_err"><%=rb.getString("PLMNTitle")%></div>
				</div>
				<div class="itemDiv pciisLock">
					<c:if test="${isElfCell != 1}">
						<span title="<%=rb.getString("RSPCI")%>"><%=rb.getString("PCI2")%></span>
						<input type="text" name="LTE_PHY_CELLID_LIST" id="mmepool_LTE_PHY_CELLID_LIST" class="border border-box item" oldValue="${PHYCELLID}" value="${PHYCELLID}"
							onblur="mmepool_validateMaxAndMinVal1(event)" min_value="0" max_value="503"
							title="int, min value: 0, max value: 503"/>
							<img src="${ctx}/skin/${manufacturer}/images/bi/pci_lock.png"/>		
						<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
						<div class="errorTitle" id="mmepool_LTE_PHY_CELLID_LIST_err">int, min value: 0, max value: 503</div>			
					</c:if>
				</div>
				<div class="itemDiv">
					<span title="<%=rb.getString("RSTAC")%>"><%=rb.getString("TAC")%></span>
					<input type="text" name="LTE_TAC"  id="mmepool_LTE_TAC"class="border border-box item" oldValue="${TAC}" value="${TAC}"
							onblur="mmepool_validateMaxAndMinVal1(event)" min_value="0" max_value="65535"
							title="int, min value: 0, max value: 65535"/>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="mmepool_LTE_TAC_err">int, min value: 0, max value: 65535</div>
				</div>
				<div class="itemDiv" style="display: none">
					<span title="<%=rb.getString("RSFrequencyBand")%>"><%=rb.getString("ZhiChiPinDuan")%></span>
					<input type="text" name="LTE_BANDS_SUPPORTED" id="mmepool_LTE_BANDS_SUPPORTED" class="border border-box item" 
					 oldValue="${BANDS_SUPPORTED}" value="${BANDS_SUPPORTED}" onblur="mmepool_commonChangeTip(event)"
							title="stringList-[1:62]"/>
					<div class="errorTitle" id="mmepool_LTE_BANDS_SUPPORTED_err">stringList-[1:62]</div>
				</div>
				<div class="itemDiv">
					<span title="<%=rb.getString("RSBandIndicator")%>"><%=rb.getString("PinDuan")%></span>
					<input type="text" name="LTE_FREQ_BAND_INDICATOR" id="mmepool_LTE_FREQ_BAND_INDICATOR" class="border border-box item" 
					 		oldValue="${FREQBAND_INDICATOR}" value="${FREQBAND_INDICATOR}"
							onblur="mmepool_validateMaxAndMinVal1(event)" min_value="1" max_value="65"
							title="int, min value: 1, max value: 65"/>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="mmepool_LTE_FREQ_BAND_INDICATOR_err">int, min value: 1, max value: 65</div>
				</div>

				<div class="itemDiv pciisLock">
					<span title="<%=rb.getString("RSEarfcn")%>"><%=rb.getString("PinDian")%></span>
					<input type="text" name="LTE_UL_DL_EARFCN" id="mmepool_LTE_UL_DL_EARFCN" class="border border-box item" oldValue="${EARFCNULINUSE}" value="${EARFCNULINUSE}"
							onblur="mmepool_validateMaxAndMinVal1(event);translateToFre(this)" onfocus="translateToEarfen(this)" min_value="0" max_value="65535"
							title="int, min value: 0, max value: 65535"/>					
						<img src="${ctx}/skin/${manufacturer}/images/bi/pci_lock.png"/>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="mmepool_LTE_UL_DL_EARFCN_err">int, min value: 0, max value: 65535</div>
				</div>
	
				<div class="itemDiv">
					<span title="PB"><%=rb.getString("WuXianDuanKouXinHaoGongLvBi")%></span>
					<select name="LTE_PB" id="mmepool_LTE_PB" class="border border-box item" oldValue="${LTE_PB}" onchange="intelTddSelectChange(event)">
						<option value=""> </option>
					...
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<input type="hidden" value="" id="mmepool_OLD_LTE_PB">
				</div>
				<div class="itemDiv" id="mmepool_intelTddMmepoolPowerModifyDiv">
					<span title="<%=rb.getString("GongLvDengJi")%>"><%=rb.getString("GongLvDengJi")%></span>
					<input name="LTE_CELL_POWER_MODIFY"  id="mmepool_LTE_CELL_POWER_MODIFY" class="border border-box item" value="${CELL_POWER_MODIFY}" oldValue="${CELL_POWER_MODIFY}"
						onblur="mmepool_validateMaxAndMinVal1(event)" min_value="15" max_value="40" />
					<div class="errorTitle" id="mmepool_LTE_CELL_POWER_MODIFY_err">int, min value: 15, max value: 40</div>
					<input type="hidden" value="" id="mmepool_OLD_LTE_CELL_POWER_MODIFY">
				</div>
				
				<div class="itemDiv" style="display:none">
					<span title="<%=rb.getString("RSDLBandWidth")%>"><%=rb.getString("XiaXingDaiKuan")%></span>
					<select name="LTE_DL_BANDWIDTH"  id="mmepool_LTE_DL_BANDWIDTH" class="border border-box item">
						<option value=""> </option>
					...
					<input type="hidden" value="" id="mmepool_OLD_LTE_DL_BANDWIDTH">
				</div>

				<div class="itemDiv">
					<span title="<%=rb.getString("RSBandwidth")%>"><%=rb.getString("DaiKuan")%></span>
					<select name="LTE_UL_BANDWIDTH" id="mmepool_LTE_UL_BANDWIDTH" class="border border-box item">
						<option value=""> </option>
						<option value="n25">5MHz</option>
						<option value="n50">10MHz</option>
						<option value="n75">15MHz</option>
					...
					<input type="hidden" value="" id="mmepool_OLD_LTE_UL_BANDWIDTH">
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
				</div>
				<div class="itemDiv">
					<span title="<%=rb.getString("RSSfAssignment")%>"><%=rb.getString("ZiZhenPeiBi")%></span>
					<select name="LTE_TDD_SUBFRAME_ASSIGNMENT" id="mmepool_LTE_TDD_SUBFRAME_ASSIGNMENT" class="border border-box item">
						<option value=""> </option>
					...
					<input type="hidden" value="" id="mmepool_OLD_LTE_TDD_SUBFRAME_ASSIGNMENT">
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
				</div>
				<div class="itemDiv">
					<span title="<%=rb.getString("RSSpecialSfPatterns")%>"><%=rb.getString("TeShuZiZhenPeiBi")%></span>
					<select name="LTE_TDD_SPECIAL_SUB_FRAME_PATTERNS" id="mmepool_LTE_TDD_SPECIAL_SUB_FRAME_PATTERNS" class="border border-box item">
						<option value=""> </option>
					...
					<input type="hidden" value="" id="mmepool_OLD_LTE_TDD_SPECIAL_SUB_FRAME_PATTERNS">
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
				</div>
				<div class="itemDiv" style="display:none">
					<span title="<%=rb.getString("RSRootSequenceIndex")%>"><%=rb.getString("GenXuLieSuoYin")%></span>
					<input type="text" name="LTE_SON_PRACH_ROOT_SEQUENCE_INDEX_LIST"  id="mmepool_LTE_ROOT_SEQ_INDEX" class="border border-box item" 
						oldValue="${ROOT_SEQUENCE_INDEX}" value="${ROOT_SEQUENCE_INDEX}"
							onblur="mmepool_validateMaxAndMinVal1(event)" min_value="0" max_value="837"
							title="int, min value: 0, max value: 837"/>
					<div class="promptTitle"><span><%=rb.getString("SheZhiCellId")%></span><span class="unmodiValue"></span></div>
					<div class="errorTitle" id="mmepool_LTE_ROOT_SEQ_INDEX_err">int, min value: 0, max value: 837</div>
				</div>
			</div>
			<%-- 网络设置面板 --%>
			<div class="intentSetting" style="padding: 20px 0 0 20px;">
				<div class="itemDiv">
					...
					<select name="UNIT_IP_PROTO"  id="mmepool_UNIT_IP_PROTO" class="border border-box item" >
						<option value="static">static</option>
						<option value="dhcp">dhcp</option>
				    </select>
				    <input type="hidden" value="" id="mmepool_OLD_UNIT_IP_PROTO">
				</div>
				<div class="itemDiv staticDiv">
					<span><%=rb.getString("WangGuan")%></span>
					<input type="text" name="UNIT_IP_GATEWAY" id="mmepool_UNIT_IP_GATEWAY"  class="border border-box staticItem"  oldValue="${GATE_WAY}"
					 		value="${GATE_WAY}" onblur="mmepool_validateIPAddress1(event)" must="1"/>
					<div class="errorTitle" id="mmepool_UNIT_IP_GATEWAY_err"><%=rb.getString("QingShuRuYiGeYouXiaoDeIPDiZhi")%></div>
				</div>
				<div class="itemDiv staticDiv">
					<span><%=rb.getString("IPDiZhi")%></span>
					<input type="text" name="UNIT_IP_ADDRESS_NEW" id="mmepool_UNIT_IP_ADDRESS_NEW" class="border border-box staticItem"  oldValue="${CELL_IP_NEW}"
							value="${CELL_IP_NEW}" onblur="mmepool_validateIPAddress1(event)" must="1"/>
					<div class="errorTitle" id="mmepool_UNIT_IP_ADDRESS_NEW_err"><%=rb.getString("QingShuRuYiGeYouXiaoDeIPDiZhi")%></div>
				</div>
				<div class="itemDiv staticDiv">
					<span><%=rb.getString("ZiWangYanMa")%></span>
					<input type="text" name="UNIT_IP_NET_MASK"  id="mmepool_UNIT_IP_NET_MASK" class="border border-box staticItem"  oldValue="${IP_NET_MASK}"
							value="${IP_NET_MASK}" onblur="mmepool_validateIPAddress1(event)" must="1"/>
					<div class="errorTitle" id="mmepool_UNIT_IP_NET_MASK_err"><%=rb.getString("QingShuRuYiGeYouXiaoDeIPDiZhi")%></div>
				</div>
				<div class="itemDiv staticDiv" style="display: none">
					<span><%=rb.getString("MoRenDnsDiZhi1")%></span>
					<input type="text" disabled="disabled" name="UNIT_IP_DNS1"  id="mmepool_UNIT_IP_DNS1" class="border border-box staticItem"  value="114.114.114.114"/>
				</div>
				<div class="itemDiv staticDiv">
					<span><%=rb.getString("MoRenDNS")%></span>
					<input type="text" disabled="disabled" name="UNIT_IP_DNS2"  id="mmepool_UNIT_IP_DNS2"class="border border-box staticItem"  value="8.8.8.8"/>
				</div>
				<div class="itemDiv staticDiv">
					<span><%=rb.getString("ZiDingYiDnsDiZhi")%></span>
					<input type="text" name="UNIT_IP_DNS"  id="mmepool_UNIT_IP_DNS" class="border border-box staticItem" oldValue=""  
							onblur="mmepool_validateIPAddress1(event)"/>
					<div class="errorTitle" id="mmepool_UNIT_IP_DNS_err"><%=rb.getString("QingShuRuYiGeYouXiaoDeIPDiZhi")%></div>
				</div>
			</div>
			<%-- ICIC设置 --%>
			<div class="ICICSetting" style="padding: 20px 0 0 20px;">
				<div id="icicConfig" style="width:100%">
					
				</div>
			</div>
			<%-- NTP设置 --%>
			<div class="NTPSetting" style="padding: 20px 0 0 20px;">
				<div class="itemDiv" style="float:none;clear:both;">
					<span><%=rb.getString("NTPTongBuShiJian")%></span>
					<input type="text" name="LTE_X_BAICELLS_NTP_SYNC_INTERVAL" id="mmepool_LTE_X_BAICELLS_NTP_SYNC_INTERVAL" class="border border-box item" oldValue="${X_BAICELLS_NTP_SYNC_INTERVAL}" value="${X_BAICELLS_NTP_SYNC_INTERVAL}"
							onblur="mmepool_validateMaxAndMinVal1(event)" min_value="10" max_value="65535"
							title="int, min value: 10, max value: 65535"/>
					<div class="errorTitle" id="mmepool_LTE_X_BAICELLS_NTP_SYNC_INTERVAL_err">int, min value: 10, max value: 65535</div>
				</div>
				<div class="itemDiv">
					<span><%=rb.getString("NTPFuWuQi1") %></span>
					<input type="text" name="LTE_NTP_SERVER_1"  id="mmepool_LTE_NTP_SERVER_1" class="border border-box item" oldValue="${NTP_SERVER_1}" value="${NTP_SERVER_1}"
							onblur="mmepool_validateMaxAndMinLength1(event)" min_length="0" max_length="256"
							title="String,min length 0,max length 256.Example:number.country.pool.ntp.org"/>
					<div class="errorTitle" id="mmepool_LTE_NTP_SERVER_1_err">String,min length 0,max length 256</div>
				</div>
				<div class="itemDiv">
					<span><%=rb.getString("NTPDuanKou1") %></span>
					<input type="text" name="LTE_NTP_PORT_1"  id="mmepool_LTE_NTP_PORT_1" class="border border-box item" oldValue="${NTP_PORT_1}" value="${NTP_PORT_1}"
							onblur="mmepool_validateMaxAndMinVal1(event)" min_value="1" max_value="20000"
							title="int, min value: 1, max value: 20000"/>
					<div class="errorTitle" id="mmepool_LTE_NTP_PORT_1_err">int, min value: 1, max value: 20000</div>
				</div>
				<div class="itemDiv">
					<span><%=rb.getString("NTPFuWuQi2") %></span>
					<input type="text" name="LTE_NTP_SERVER_2" id="mmepool_LTE_NTP_SERVER_2"  class="border border-box item" oldValue="${NTP_SERVER_2}" value="${NTP_SERVER_2}"
							onblur="mmepool_validateMaxAndMinLength1(event)" min_length="0" max_length="256"
							title="String,min length 0,max length 256.Example:number.country.pool.ntp.org"/>
					<div class="errorTitle" id="mmepool_LTE_NTP_SERVER_2_err">String,min length 0,max length 256</div>
				</div>
				<div class="itemDiv">
					<span><%=rb.getString("NTPDuanKou2") %></span>
					<input type="text" name="LTE_NTP_PORT_2"  id="mmepool_LTE_NTP_PORT_2" class="border border-box item" oldValue="${NTP_PORT_2}" value="${NTP_PORT_2}"
							onblur="mmepool_validateMaxAndMinVal1(event)" min_value="1" max_value="20000"
							title="int, min value: 1, max value: 20000"/>
					<div class="errorTitle" id="mmepool_LTE_NTP_PORT_2_err">int, min value: 1, max value: 20000</div>
				</div>
				<div class="itemDiv">
					<span><%=rb.getString("NTPFuWuQi3") %></span>
					<input type="text" name="LTE_NTP_SERVER_3" id = "mmepool_LTE_NTP_SERVER_3" class="border border-box item" oldValue="${NTP_SERVER_3}" value="${NTP_SERVER_3}"
							onblur="mmepool_validateMaxAndMinLength1(event)" min_length="0" max_length="256"
							title="String,min length 0,max length 256.Example:number.country.pool.ntp.org"/>
					<div class="errorTitle" id="mmepool_LTE_NTP_SERVER_3_err">String,min length 0,max length 256</div>
				</div>
				<div class="itemDiv">
					<span><%=rb.getString("NTPDuanKou3") %></span>
					<input type="text" name="LTE_NTP_PORT_3"  id="mmepool_LTE_NTP_PORT_3" class="border border-box item" oldValue="${NTP_PORT_3}" value="${NTP_PORT_3}"
							onblur="mmepool_validateMaxAndMinVal1(event)" min_value="1" max_value="20000"
							title="int, min value: 1, max value: 20000"/>
					<div class="errorTitle" id="mmepool_LTE_NTP_PORT_3_err">int, min value: 1, max value: 20000</div>
				</div>
				<div class="itemDiv">
					<span><%=rb.getString("NTPFuWuQi4") %></span>
					<input type="text" name="LTE_NTP_SERVER_4"  id="mmepool_LTE_NTP_SERVER_4" class="border border-box item" oldValue="${NTP_SERVER_4}" value="${NTP_SERVER_4}"
							onblur="mmepool_validateMaxAndMinLength1(event)" min_length="0" max_length="256"
							title="String,min length 0,max length 256.Example:number.country.pool.ntp.org"/>
					<div class="errorTitle" id="mmepool_LTE_NTP_SERVER_4_err">String,min length 0,max length 256</div>
				</div>
				<div class="itemDiv">
					<span><%=rb.getString("NTPDuanKou4") %></span>
					<input type="text" name="LTE_NTP_PORT_4" id="mmepool_LTE_NTP_PORT_4"  class="border border-box item" oldValue="${NTP_PORT_4}" value="${NTP_PORT_4}"
							onblur="mmepool_validateMaxAndMinVal1(event)" min_value="1" max_value="20000"
							title="int, min value: 1, max value: 20000"/>
					<div class="errorTitle" id="mmepool_LTE_NTP_PORT_4_err">int, min value: 1, max value: 20000</div>
				</div>
			</div>
			<!-- IPSEC 设置 -->
			<div class="IPSECSetting" style="padding: 20px 0 0 20px;display:none" id="mmepool_IPSECDIV">
			...
			<div class="LGWSetting" style="padding: 20px 0 0 20px;" id="lgw">
				...
				<div class="itemDiv staticDiv lgw" name="LGW" id="1" style="float:none;clear:both;">
					...
					<input type="text"  name="LGW_IMSI"  id="intelTdd_LGW_IMSI"  class="border border-box itemStatisticInput" style="width:169px;height:26px;padding-left:10px" oldValue="" 
							onblur="imsionblur(event)" title="<%=rb.getString("LGWImsiTiShi")%>"/>
					-
					<input type="text"  name="LGW_IMSI_IP"  id="intelTdd_LGW_IMSI_IP"  class="border border-box itemStatisticInput" style="width:169px;height:26px;padding-left:10px" 
							onblur="validateipandrangeforbinding(event)" oldValue="" title="<%=rb.getString("LGWIpTiShi")%>"/>
		...
		<div class="windowButtonGroup" style="position:absolute;bottom:37px;left:47px;">
			<a class="easyui-linkbutton linkbutton linkbutton_trend" onclick="mmepool_cellSettingCommit()"><span><%=rb.getString("QueDing")%></span></a>
...
<%-- 窗口-右键设置进度条 --%>
<div id="mmepool_winSettingPro" title="<%=rb.getString("CanShuPeiZhiJinDu")%>" class="easyui-window"
...
$("select[name='LTE_UL_BANDWIDTH']").bind("change",function(){
	...
	//选中新选择的元素
	$("select[name='LTE_DL_BANDWIDTH']").val(this.value);
	var opts = $("select[name='LTE_DL_BANDWIDTH']").find("option");
	var oldValue=$("#mmepool_OLD_LTE_UL_BANDWIDTH").val();
	var ele = $(this);
	var oldValueText = "";
	...
	for(var i=0;i<opts.length;i++){
		if(opts[i].value == this.value){
			...
			if(oldValue!=this.value){
				$("#mmepool_LTE_UL_BANDWIDTH").css({"color":"blue"});
				$("#mmepool_LTE_UL_BANDWIDTH option").css({"color":"black"});
				ele.siblings(".promptTitle").show();
		    	ele.siblings(".promptTitle").find(".unmodiValue").text(oldValueText);
			}else{
				$("#mmepool_LTE_UL_BANDWIDTH").css({"color":"black"});	
...
var bandWidth = "${UL_BANDWIDTH}";
$("#icicConfig").panel({
	border : false,
	onBeforeLoad:function(param){
		param["bandWidth"] = bandWidth;
		param["smallCellCode"]='<%=request.getParameter("smallCellCode") %>';
	},
	href: '${ctx}/cell/param/toICICPage.action'
});

function mmepool_informICICPRBRang(e){
	var ele = $(e["target"]);
	bandWidth = ele.val();
	$("#icicConfig").panel("refresh");
}
...
$("select[name='LTE_TDD_SUBFRAME_ASSIGNMENT']").bind("change",function(){
	...
	var oldValue=$("#mmepool_OLD_LTE_TDD_SUBFRAME_ASSIGNMENT").val();
	var ele = $(this);
	var oldValueText = "";
	for(var i=0;i<opts.length;i++){
		if(opts[i].value == oldValue){
	...
	for(var i=0;i<opts.length;i++){
		if(opts[i].value == this.value){
			$(opts[i]).attr("selected",true);
			if(oldValue!=this.value){
				$("#mmepool_LTE_TDD_SUBFRAME_ASSIGNMENT").css({"color":"blue"});
				$("#mmepool_LTE_TDD_SUBFRAME_ASSIGNMENT option").css({"color":"black"});
				ele.siblings(".promptTitle").show();
		    	ele.siblings(".promptTitle").find(".unmodiValue").text(oldValueText);
			}else{
				$("#mmepool_LTE_TDD_SUBFRAME_ASSIGNMENT").css({"color":"black"});	
				ele.siblings(".promptTitle").hide();
			}
			break;
		}
...
$("select[name='LTE_TDD_SPECIAL_SUB_FRAME_PATTERNS']").bind("change",function(){
	...
	var oldValue=$("#mmepool_OLD_LTE_TDD_SPECIAL_SUB_FRAME_PATTERNS").val();
	var ele = $(this);
	var oldValueText = "";
	for(var i=0;i<opts.length;i++){
		if(opts[i].value == oldValue){
	...
	for(var i=0;i<opts.length;i++){
		if(opts[i].value == this.value){
			$(opts[i]).attr("selected",true);
			if(oldValue!=this.value){
				$("#mmepool_LTE_TDD_SPECIAL_SUB_FRAME_PATTERNS").css({"color":"blue"});
				$("#mmepool_LTE_TDD_SPECIAL_SUB_FRAME_PATTERNS option").css({"color":"black"});
				ele.siblings(".promptTitle").show();
		    	ele.siblings(".promptTitle").find(".unmodiValue").text(oldValueText);
			}else{
				$("#mmepool_LTE_TDD_SPECIAL_SUB_FRAME_PATTERNS").css({"color":"black"});
				ele.siblings(".promptTitle").hide();
			}
			break;
		}
...
$("select[name='UNIT_IP_PROTO']").bind("change",function(){
	...
	var oldValue=$("#mmepool_OLD_UNIT_IP_PROTO").val();
	var ele = $(this);
	var oldValueText = "";
	for(var i=0;i<opts.length;i++){
		if(opts[i].value == oldValue){
	...
	for(var i=0;i<opts.length;i++){
		if(opts[i].value == this.value){
			$(opts[i]).attr("selected",true);
			if(oldValue!=this.value){
				$("#mmepool_UNIT_IP_PROTO").css({"color":"blue"});
				$("#mmepool_UNIT_IP_PROTO option").css({"color":"black"});
				ele.siblings(".promptTitle").show();
		    	ele.siblings(".promptTitle").find(".unmodiValue").text("");
			}else{
				$("#mmepool_UNIT_IP_PROTO").css({"color":"black"});	
				ele.siblings(".promptTitle").hide();
			}
			break;
		}
...
function mmepool_authbyChange(e){
	var ele = $(e["target"]);
	...
	mmepool_changeColor(ele.attr("id"));
}
function mmepool_bindInterface(e){
	var ele = $(e["target"]);
	mmepool_changeColor(ele.attr("id"))
}
...
$(function() {
	...
	closeLoading();
	var mmeearoldVal = "${EARFCNDLINUSE}";
	var mmeearfcnVal = translateToFre(mmeearoldVal);
	$("#mmepool_LTE_UL_DL_EARFCN").val(mmeearfcnVal);
	...
	//如果SAS开关打开，则该参数不可配置
	if(SASEnble == "1"){
		$("#mmepool_LTE_UL_DL_EARFCN").attr("disabled",true);
		$("#mmepool_LTE_UL_BANDWIDTH").attr("disabled",true).css("background","#EAF1F4");
	}
	...
	if ("${IP_PROTO}" == "") {
		...
		$("#mmepool_OLD_UNIT_IP_PROTO").val("dhcp");
	} else {
		$("select[name='UNIT_IP_PROTO']").val("${IP_PROTO}");
		$("#mmepool_OLD_UNIT_IP_PROTO").val("${IP_PROTO}");
	}
	
	$("#mmepool_OLD_LTE_DL_BANDWIDTH").val("${DL_BANDWIDTH}");
	$("#mmepool_OLD_LTE_UL_BANDWIDTH").val("${UL_BANDWIDTH}");
	$("#mmepool_OLD_LTE_TDD_SUBFRAME_ASSIGNMENT").val("${SUBFRAME_ASSIGNMENT}");
	$("#mmepool_OLD_LTE_TDD_SPECIAL_SUB_FRAME_PATTERNS").val("${SPECIAL_SUBFRAME_PATTERNS}");

	$("#mmepool_LTE_PB").val("${LTE_PB}");
	$("#mmepool_OLD_LTE_PB").val("${LTE_PB}");
	if ("${LTE_CELL_POWER_MODIFY_LIST}" == "" && false) {
		$("#mmepool_intelTddMmepoolPowerModifyDiv").css("display", "none");
	} else {
		//获取可以修改的参数信号功率列表
		/* var powerModifyList = "${LTE_CELL_POWER_MODIFY_LIST}";
		if (powerModifyList.indexOf("[") > -1) {
			//是一个类似[15,21]的范围
			var rangeStr = powerModifyList.substring (1, powerModifyList.length - 1);
			var rangeArr = rangeStr.split(",");
			var minNum = rangeArr[0];
			var minMax = rangeArr[1];
			for (var count = minNum; count <= minMax; count++) {
				var opt = null;
				if ("${CELL_POWER_MODIFY}" == count) {
					opt = "<option value='"+count+"' selected='selected'>"+count+"</option>";
				} else {
					opt = "<option value='"+count+"'>"+count+"</option>";
				}
				
				$("#mmepool_LTE_CELL_POWER_MODIFY").append(opt);
			}
		} else {
			var opt = "<option value='"+powerModifyList+"' selected='selected'>"+powerModifyList+"</option>";
			
			$("#mmepool_LTE_CELL_POWER_MODIFY").append(opt);
			$("#mmepool_LTE_CELL_POWER_MODIFY").attr("disable", "disable");
		} */
		setTimeout(function(){
			$("#mmepool_LTE_CELL_POWER_MODIFY").next().find('input:visible').attr("oldvalue","${CELL_POWER_MODIFY}");
		},0);
		$("#mmepool_OLD_LTE_CELL_POWER_MODIFY").val("${CELL_POWER_MODIFY}");
	}

	<%-- 生成Ipsec--%>
	var cellIpsecInfos = ${cellIpsecInfos};
	var ipsecBindInterface = ${ipsecBindInterface};  
	
	var BangDingJieKou = "";
	if(ipsecBindInterface.length != 0 && ipsecBindInterface.BIND_INTERFACE_LIST != ""){
		var BIND_INTERFACE_LIST = ipsecBindInterface.BIND_INTERFACE_LIST;
		var LEFT_INTERFACE = ipsecBindInterface.LEFT_INTERFACE;
		var bandChoice = "{";
		var bandInterList = BIND_INTERFACE_LIST.split(",");
		var regex = /.*?\((.*?)\)/;
		for(var j=0;j<bandInterList.length;j++){
			//如果当前值不满足要求，则终止当前循环，继续下一个循环
			if(!regex.test(bandInterList[j])){
				continue;
			}
			...
			var result = regex.exec(bandInterList[j]);
				
			if(j == bandInterList.length - 1){
				bandChoice = bandChoice + "\"" + bandInterList[j] + "\":\"" + result[1] +"\"";
			}else{
				bandChoice = bandChoice + "\"" + bandInterList[j] + "\":\"" + result[1] +"\"" + ",";
			}
		}
		...
		var jsonBandChoice = eval("(" + bandChoice +")");
		BangDingJieKou =mmepool_createIpsecSelectDiv(jsonBandChoice,LEFT_INTERFACE,'<%=rb.getString("BangDingJieKou") %>',"LEFT_INTERFACE");
	}
	
	if(BangDingJieKou.length > 0){
		$("#mmepool_IPSECDIV").append(BangDingJieKou);
		$("select[name^='LEFT_INTERFACE']").change(mmepool_bindInterface);
	}
	
	if(cellIpsecInfos.length==0 && BangDingJieKou.length == 0){
		$("#mmepool_IPSECDIV").append('<%=rb.getString("IpsecTiShi") %>');
	}else{
		for(var i=0;i<cellIpsecInfos.length;i++){
			var ID = cellIpsecInfos[i].ID;
			//创建ID文本框
			var IDDIV = mmepool_createIpsecInputDiv('<%=rb.getString("SuoYin") %>',"ID_"+ID,ID,true);
			var TunnelMingChengDIV = mmepool_createIpsecInputDiv('<%=rb.getString("TunnelMingCheng") %>',"TUNNEL_NAME_"+ID,cellIpsecInfos[i].TUNNEL_NAME);
			var TunnelWangGuanDIV = mmepool_createIpsecInputDiv('<%=rb.getString("TunnelWangGuan") %>',"TUNNEL_GATEWAY_"+ID,cellIpsecInfos[i].TUNNEL_GATEWAY);
			var IpsecZiWangDIV = mmepool_createIpsecInputDiv('<%=rb.getString("IpsecZiWang") %> ',"RIGHT_SUBNET_"+ID,cellIpsecInfos[i].RIGHT_SUBNET);
			var MuDiDuanBiaoJiFuDIV = mmepool_createIpsecInputDiv('<%=rb.getString("MuDiDuanBiaoJiFu") %>',"RIGHT_IDENTIFIER_"+ID,cellIpsecInfos[i].RIGHT_IDENTIFIER);
			var RenZhengFangShiDIV =mmepool_createIpsecSelectDiv({"psk":"psk","cert":"cert","aka_psk":"aka_psk","aka_cert":"aka_cert"},cellIpsecInfos[i].AUTHBY,'<%=rb.getString("RenZhengFangShi") %>',"AUTHBY_"+ID);
			var YuGongXiangMiYaoDIV = mmepool_createIpsecInputPasswordDiv('<%=rb.getString("YuGongXiangMiYao") %>',"PRE_SHARED_KEY_"+ID,cellIpsecInfos[i].PRE_SHARED_KEY);
			
			if("${isSuperAdmin}" == "1"){//超级管理员可以查看预共享秘钥
				$("#mmepool_IPSECDIV").append(IDDIV).append(TunnelMingChengDIV).append(TunnelWangGuanDIV).append(IpsecZiWangDIV).append(MuDiDuanBiaoJiFuDIV).append(RenZhengFangShiDIV).append(YuGongXiangMiYaoDIV);
			}else{
				$("#mmepool_IPSECDIV").append(IDDIV).append(TunnelMingChengDIV).append(TunnelWangGuanDIV).append(IpsecZiWangDIV).append(MuDiDuanBiaoJiFuDIV).append(RenZhengFangShiDIV);
			}
		}
		...
		$("input[name^='TUNNEL_GATEWAY']").blur(validateMaxAndMinLength).attr("min_length",0).attr("max_length",256).attr("title","string, min length: 0, max length: 256");
		$("input[name^='RIGHT_SUBNET']").blur(validateMaxAndMinLength).attr("min_length",0).attr("max_length",256).attr("title","string, min length: 0, max length: 256");
		$("input[name^='RIGHT_IDENTIFIER']").blur(validateMaxAndMinLength).attr("min_length",0).attr("max_length",256).attr("title","string, min length: 0, max length: 256");
		$("input[name^='PRE_SHARED_KEY_']").blur(validateMaxAndMinLength).attr("min_length",0).attr("max_length",256).attr("title","string, min length: 0, max length: 256");
		
		$("select[name^='AUTHBY']").change(mmepool_authbyChange);
	}
	...
	//初始化核心网地址输入框
	var mmePool1 = "${MME_POOL_1}";
	var mmePool2 = "${MME_POOL_2}";
	
	if (mmePool1 != "") {
		var mmeArr = mmePool1.split(",");
		//当mme地址为n且n>1时，需要重新生成n-1个输入框
		if (mmeArr.length > 1) {
			//初始化第一个输入框的值和oldValue值
			var firstMMEDiv = $("input[name='LTE_X_BAICELLS_POOL_MME_LIST1']:first");
			...
			for(var count = 1; count < newMMEInputCount; count++) {
				...
				var $mmeInput = $("<input type='text' name='LTE_X_BAICELLS_POOL_MME_LIST1' class='border border-box item' "
						+ "id='LTE_X_BAICELLS_POOL_MME_LIST1_org_"+count+"' onblur='mmepool_validateIPAddress11(event)' oldValue='" + mmeArr[count] + "' value='" + mmeArr[count] + "' style='margin-left:0px'></input>");
				var $mmeButtn = $("<a onclick='mmepool_removeMMEIpInputText(this)' style='margin-left:3px'>" 
				...
				var $tip = $("<div class='promptTitle'><span><%=rb.getString("SheZhiCellId")%></span><span class='unmodiValue'></span></div>" + 
						"<div class='errorTitle' id='LTE_X_BAICELLS_POOL_MME_LIST1_org_"+ count +"_err'><%=rb.getString("QingShuRuYiGeYouXiaoDeIPDiZhi")%></div>");
				...
				//将新增的输入框插入到plmn参数之前
				var plmnidDiv = $("input[name='LTE_X_BAICELLS_POOL_MME_LIST2']").parent("div");
	...
	if (mmePool2 != "") {
		var mmeArr = mmePool2.split(",");
		//当mme地址为n且n>1时，需要重新生成n-1个输入框
		if (mmeArr.length > 1) {
			//初始化第一个输入框的值和oldValue值
			var firstMMEDiv = $("input[name='LTE_X_BAICELLS_POOL_MME_LIST2']:first");
			firstMMEDiv.val(mmeArr[0]);
			firstMMEDiv.attr("oldValue", mmeArr[0]);
			...
			for(var count = 1; count < newMMEInputCount; count++) {
				...
				var $mmeSpan = $("<span style='display:inline-block;visibility:hidden'><%=rb.getString("HeXinWang")%></span>");
				var $mmeDiv = $("<div class='itemDiv'></div>");
				var $mmeInput = $("<input type='text' name='LTE_X_BAICELLS_POOL_MME_LIST2' class='border border-box item' "
...
<%-- 关闭窗口 --%>
function mmepool_closeSelfWin() {
	/* $("#winCellSettings").window("close"); */
	closeDefaultWindow();
}
<%-- 提交 --%>
function mmepool_cellSettingCommit() {
	...
	$.post("${ctx}/cell/cpeinfos/getCellConnStatus.action", {"small_cell_code": cellCode}, function(data){
		...
		if(data["connStatus"] == "false") {
			...
			if ($("#mmepool_compactParamConfig .item.err_border").length > 0) {
				return;
			}
			if($("select[name='LGW_ENABLE']").val()=="1"){
				var lgwModeSelect = $("select[name='LGW_MODE']").val();
				if(lgwModeSelect=='NAT'){
					if ($("#mmepool_compactParamConfig .lgwInput.err_border").length > 0) {
						return;
					}
					...
					if(selectStaticAddrInput == "1") {
						if ($("#mmepool_compactParamConfig .itemStatisticInput.err_border").length > 0) {
							return;
						}
					}
				}
			...
			if(selectProto == "static") {
				if ($("#mmepool_compactParamConfig .staticItem.err_border").length > 0) {
					return;
				}
			}
			...
			$("#mmepool_compactParamConfig .item,.lgwInput,.itemStatisticInput").each(function() {
				...
				if(oldValue == undefined){
					...
					if(reg.test(paramName)){
						...
						oldValue = $("#mmepool_" + selectId).val();
					}
				}
				//核心网地址参数特殊处理
				if (paramName == "LTE_X_BAICELLS_POOL_MME_LIST1" || paramName == "LTE_X_BAICELLS_POOL_MME_LIST2") {
			...
			if (params["LTE_X_BAICELLS_POOL_MME_LIST1"] != null ) {
				var tempMmeAddress = params["LTE_X_BAICELLS_POOL_MME_LIST1"];
				var mmeAddress = tempMmeAddress.substring(0, tempMmeAddress.length - 1);
				if (mmeAddress == "${MME_POOL_1}") {
					//删除params对象的LTE_SIGLINK_SERVER_LIST属性
					delete params.LTE_X_BAICELLS_POOL_MME_LIST1;
				} else {
					params["LTE_X_BAICELLS_POOL_MME_LIST1"] = mmeAddress;
				}
			}
			
			if(params["LTE_X_BAICELLS_POOL_MME_LIST2"] != null){
				var tempMmeAddress = params["LTE_X_BAICELLS_POOL_MME_LIST2"];
				var mmeAddress = tempMmeAddress.substring(0, tempMmeAddress.length - 1);
				if (mmeAddress == "${MME_POOL_2}") {
					//删除params对象的LTE_SIGLINK_SERVER_LIST属性
					delete params.LTE_X_BAICELLS_POOL_MME_LIST2;
				} else {
					params["LTE_X_BAICELLS_POOL_MME_LIST2"] = mmeAddress;
				}
			}
			//获取用户选择的方式
			var selectProto = $("select[name='UNIT_IP_PROTO']").val();
				...
				if (isReboot(params) || lgwchange || icicreboot) {
					...
					if ("${noReboot}" == 1) {
						...
						$.messager.confirm("<%=rb.getString("QueRen")%>", promptInfo, function (r) {
				            if (r) {
				            	$("#mmepool_winSettingPro").window("open");
				            	//请求修改参数
				    			$.post("${ctx}/cell/param/compactParamConfig.action", params, function(data) {
				    				$("#mmepool_winSettingPro").window("close");
				    				if (data["success"]) {
				    					mmepool_closeSelfWin();
				    					$.messager.alert(TiShi, "<%=rb.getString("CaoZuoChengGong")%>");
				    					//重启基站
				    					var param = {
				    							cell_code: cellCode,
				    							productType: enbvm.selectedRow.product_type
				    					};
...
var randomNum_mmepool = 0;
//添加一个MME地址输入框
function mmepool_addMMEIpInputText(e,flag) {
	randomNum_mmepool += 1;
	if(flag == 1){
		//添加新的输入框
		var oldValue =$("input[id='LTE_X_BAICELLS_POOL_MME_LIST1']").first().attr("oldValue");
		var $mmeSpan = $("<span style='display:inline-block;visibility:hidden'><%=rb.getString("HeXinWang")%></span>");
		var $mmeDiv = $("<div class='itemDiv'></div>");
		var $mmeInput = $("<input type='text' name='LTE_X_BAICELLS_POOL_MME_LIST1' class='border border-box item' "
			 + "id='LTE_X_BAICELLS_POOL_MME_LIST1_"+randomNum_mmepool+"' onblur='mmepool_validateIPAddress11(event)'  oldValue='' style='margin-left:0px'></input>");
		var $mmeButtn = $("<a onclick='mmepool_removeMMEIpInputText(this)' style='margin-left:3px'>" 
				+ "<img src='${ctx}/skin/${manufacturer}/images/bi/setting_sub.png'/></a>");
		var $tip = $("<div class='promptTitle'><span><%=rb.getString("SheZhiCellId")%></span><span class='unmodiValue'></span></div>" + 
				"<div class='errorTitle' id='LTE_X_BAICELLS_POOL_MME_LIST1_"+ randomNum_mmepool +"_err'><%=rb.getString("QingShuRuYiGeYouXiaoDeIPDiZhi")%></div>");
		...
		//将新增的输入框插入到mmepool2参数之前
		var plmnidDiv = $("input[id='mmepool_LTE_X_BAICELLS_POOL_MME_LIST2']").parent("div");
		$mmeDiv.insertBefore(plmnidDiv);
		
		//将当前输入框后面的图标改为删除图标，并重新绑定事件
		$(e).children("img").attr("src","${ctx}/skin/${manufacturer}/images/bi/setting_add.png");
		$(e).attr("onclick", "mmepool_addMMEIpInputText(this,1)");
	}else{
		//添加新的输入框
		var oldValue =$("input[id='LTE_X_BAICELLS_POOL_MME_LIST2']").first().attr("oldValue");
		var $mmeSpan = $("<span style='display:inline-block;visibility:hidden'><%=rb.getString("HeXinWang")%></span>");
		var $mmeDiv = $("<div class='itemDiv'></div>");
		var $mmeInput = $("<input type='text' name='LTE_X_BAICELLS_POOL_MME_LIST2' class='border border-box item' "
			 + "id='LTE_X_BAICELLS_POOL_MME_LIST2_"+randomNum_mmepool+"' onblur='mmepool_validateIPAddress11(event)'  oldValue='"+oldValue+"' style='margin-left:0px'></input>");
		var $mmeButtn = $("<a onclick='mmepool_removeMMEIpInputText(this)' style='margin-left:3px'>" 
				+ "<img src='${ctx}/skin/${manufacturer}/images/bi/setting_sub.png'/></a>");
		var $tip = $("<div class='promptTitle'><span><%=rb.getString("SheZhiCellId")%></span><span class='unmodiValue'></span></div>" + 
				"<div class='errorTitle' id='LTE_X_BAICELLS_POOL_MME_LIST2_"+ randomNum_mmepool +"_err'><%=rb.getString("QingShuRuYiGeYouXiaoDeIPDiZhi")%></div>");
		...
		//将当前输入框后面的图标改为删除图标，并重新绑定事件
		$(e).children("img").attr("src","${ctx}/skin/${manufacturer}/images/bi/setting_add.png");
		$(e).attr("onclick", "mmepool_addMMEIpInputText(this,2)");
	}
}
//删除选中的MME地址输入框
function mmepool_removeMMEIpInputText(e) {
	$(e).parent("div").remove();
...
function mmepool_createIpsecInputDiv(name,filedName,value,disabled){
  /*   var mes = "\<\%=rb.getString(\'"+tip+"\')\%\>"; */ 
	if(disabled == true){
		...
		var div = "<div class='itemDiv'><span>"+name+"</span><input id='mmepool_"+filedName+"' onblur='mmepool_commonChangeTip(event)' type='text' name='"+filedName+"' class='border border-box item'  oldValue='"
	   +value+"' value='"+value+"'/></div>";
	}
	return $(div);
}

function mmepool_createIpsecInputPasswordDiv(name,filedName,value,disabled){
	var tip = mmepool_createTitleForIpSec(filedName);
	if(disabled == true){
		var div = "<div class='itemDiv'><span>"+name+"</span><input type='password' name='"+filedName+"' class='border border-box item' oldValue='"
		+value+"' value='"+value+"' disabled='disabled'/></div>";
	}else{
		var div = "<div class='itemDiv'><span>"+name+"</span><input type='password' id='mmepool_" + filedName + "' onblur='mmepool_commonChangeTip(event)' name='"+filedName+"' class='border border-box item'  oldValue='"
	   +value+"' value='"+value+"'/></div>";
	}
	return $(div);
}

function mmepool_createIpsecSelectDiv(jsonOption,selectedValue,name,filedName){
	...
	var selectHtml="<select name='"+filedName+"' id='mmepool_" + filedName + "' class='border border-box item'>"+opts+"</select>";
	if (!selectedValue) {
		selectedValue = "";
	}
	var div = "<div class='itemDiv'><span>"+name+"</span>"+selectHtml+"<input type='hidden' value='"+selectedValue+"' id='mmepool_OLD_"+filedName+"'>";
	return $(div);
}


function mmepool_validateMaxAndMinVal1(e) {
    var ele = $(e["target"]);
    ele.siblings(".promptTitle").hide();
    ...
    if(!$("#" + ele.attr("id") + "_err").is(':visible')){
	    ...
	    if(id=="LTE_FREQ_BAND_INDICATOR"){
	    	$("#mmepool_LTE_BANDS_SUPPORTED").val(currVal);
	    }
    }
}


function mmepool_validateMaxAndMinLength1(e){
  	var ele = $(e["target"]);
    var currVal = ele.val();
    var oldValue = ele.attr("oldValue");
    if(currVal!=oldValue){
...
function mmepool_validateHostName(e){
	var ele = $(e["target"]);
    var currVal = ele.val();
...
function mmepool_validateIPAddress1(e){
	var ele = $(e["target"]);
    ele.siblings(".promptTitle").hide();
    validateIPAddress(e);
    if(!$("#" + ele.attr("id") + "_err").is(':visible')){
...
function mmepool_validateIPAddress11(e){
  	var ele = $(e["target"]);
    ele.siblings(".promptTitle").hide();
    validateIPAddress(e);
    if(!$("#" + ele.attr("id") + "_err").is(':visible')){
...
function mmepool_commonChangeTip(e){
  	var ele = $(e["target"]);
    var currVal = ele.val();
    var oldValue = ele.attr("oldValue");
    if(currVal!=oldValue){
...
function mmepool_changeColor(id){
...
function mmepool_createTitleForIpSec(fieldName){
}
...
function intelTdd_addISMIAndIPInputText(e) {
	...
	var $mmeInput = $("<input type='text' name='LGW_IMSI' class='border border-box itemStatisticInput' style='width:169px;height:26px;margin-left:0px;padding-left:10px' "   + " title='<%=rb.getString("LGWImsiTiShi")%>'"
		 + "id='intelTdd_LGW_IMSI_"+imsiIP_mmepool+"' onblur='imsionblur(event)'  oldValue='"+oldValue+"' ></input>"
		 +" - "
		 ...
		 + "id='intelTdd_LGW_IMSI_IP_"+imsiIP_mmepool+"' onblur='validateipandrangeforbinding(event)'  oldValue='"+oldValue+"' ></input>"
	);
	var $mmeButtn = $("<a onclick='intelTdd_removeIMSIAndIPInputText(this)' style='margin-left:3px' >" 
			+ "<img src='${ctx}/skin/${manufacturer}/images/bi/setting_sub.png'/></a>"); 
	var $tip = $("<div class='errorTitle' id='intelTdd_LGW_IMSI_"+ imsiIP_mmepool +"_err'><%=rb.getString("LGWImsiTiShi")%></span></div>"+
		    "<div class='errorTitle' id='intelTdd_LGW_IMSI_IP_"+ imsiIP_mmepool +"_err'><%=rb.getString("LGWIpTiShi")%></span></div>");
...
$("#intelTdd_LGW_ENABLE").bind("change",function(){
	//移除之前被选中的元素
	//$("#intelTdd_LGW_ENABLE option:selected").removeAttr("selected");
	//选中新选择的元素
	var opts = $("#intelTdd_LGW_ENABLE").find("option");
	var oldValue=$("#intelTdd_OLD_LGW_ENABLE").attr("oldValue");
	for(var i=0;i<opts.length;i++){
		if(opts[i].value == this.value){
			$(opts[i]).attr("selected",true);
			if(oldValue!=this.value){
				$("#intelTdd_LGW_ENABLE").css({"color":"blue"});
				$("#intelTdd_LGW_ENABLE option").css({"color":"black"});
			}else{
				$("#intelTdd_LGW_ENABLE").css({"color":"black"});	
			}
			break;
		}
	}
});
$("#intelTdd_LGW_MODE").bind("change",function(){
	//移除之前被选中的元素
	//$("#intelTdd_LGW_MODE option:selected").removeAttr("selected");
	//选中新选择的元素
	var opts = $("#intelTdd_LGW_MODE").find("option");
	var oldValue=$("#intelTdd_OLD_LGW_MODE").attr("oldValue");
	for(var i=0;i<opts.length;i++){
		if(opts[i].value == this.value){
			$(opts[i]).attr("selected",true);
			if(oldValue!=this.value){
				$("#intelTdd_LGW_MODE").css({"color":"blue"});
				$("#intelTdd_LGW_MODE option").css({"color":"black"});
			}else{
				$("#intelTdd_LGW_MODE").css({"color":"black"});	
			}
			break;
		}
	}
...
//下拉框选择内容发生变化
function intelTddSelectChange(e){
	var ele = $(e["target"]);
	var oldValue = ele.attr("oldValue");
	var currVal = ele.find("option:selected").text();
    if(currVal!=oldValue){
    	$("#" +ele.attr("id")).css({"color":"blue"});
    	ele.siblings(".promptTitle").show();
    	ele.siblings(".promptTitle").find(".unmodiValue").text(oldValue);
...
function isReboot(ele){
	if(ele["LTE_CELL_ECI"] != null || ele["LTE_DL_BANDWIDTH"] != null  || ele["LTE_DL_EARFCN"] != null  ||  ele["LTE_FREQ_BAND_INDICATOR"] != null  || ele["LTE_OAM_PLMNID"] != null  || ele["LTE_PB"] != null  || ele["LTE_PHY_CELLID_LIST"] != null  || ele["LTE_SIGLINK_SERVER_LIST"] != null  || 
