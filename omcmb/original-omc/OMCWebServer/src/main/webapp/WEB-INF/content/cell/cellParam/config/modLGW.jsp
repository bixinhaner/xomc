...
<ul id="paramNodesUl" class="paramNodesUl">
    ...
    <li name="LGW">
        <label for="LTE_LGW_IFNAME_name">${LTE_LGW_IFNAME_name }</label>
        <select id="LTE_LGW_IFNAME_name" name="LTE_LGW_IFNAME" class="border border-box" onblur="createMML();" onchange="LGWModeChange(this)">
