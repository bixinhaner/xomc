...
<style>
	...
	#cell2InfoPage .subInputCls .el-select>.el-input{
		width: 150px!important;
	}
	#cell2InfoPage .EnergySavingTypeSelectCls .el-select>.el-input{
		width: 110px!important;
	}
	#cell2InfoPage .specialItem .el-input__inner{
		width:110px !important;
	}
	#cell2InfoPage .specialItem .el-input-group__append{
		padding-left: 50px!important;
	}
	
</style>

<div id="cell2InfoPage">
...
var cell2InfoVue =  new Vue({
	...
	mounted(){
		...
		eventBus.$off('cell2-submit').$on('cell2-submit',this.cell2Submit);
	}
