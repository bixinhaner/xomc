...
#addMMLScriptTask .ml45{
	margin-left: 45px
}
#addMMLScriptTask .mt20{
	margin-top: 20px
}
#addMMLScriptTask .taskInput {
	width: 300px;
	height: 28px;
	line-height: 28px;	
}
#addMMLScriptTask .el-form-item__label {
	line-height:26px;
	width:140px;
	text-align:left;
}
#addMMLScriptTask .titleStyML {
	margin-left: 20px;
	margin-top: 15px;
}
...
.normal-padding .el-dialog__body {
	padding: 10px 20px !important;
}
</style>

<!-- 新建MML Script任务 -->
<div id="addMMLScriptTask">
	...
	>
		...
		<el-form-item class="ml45 mt20">
			<div>
				...
				<el-form-item class="inline-form-item" prop="time" style="width: 400px;margin-left: 10px;">
			...
			<div style="margin-top: 15px;">
				...
				<el-form-item class="inline-form-item" prop="periodStartTime" style="margin-left: 10px;">
				...
				:
				<el-form-item class="inline-form-item" prop="periodTime">
		...
		<el-form-item class="ml45 mt20">
			<div style='margin: 0;'>
				<div>
					...
					<el-form-item class="inline-form-item" prop="offlineRetryWaitTime">
						<el-input v-model="form.offlineRetryWaitTime" :disabled="isView" type="number" style="width: 80px;"></el-input> <!-- min:20 max:10080 default:60 -->
					</el-form-item>
				...
				<div style="margin:20px 0;">
					...
					<el-form-item class="inline-form-item" prop="failedRetryCount">
					...
					<el-form-item class="inline-form-item" prop="failedRetryWaitTime">
	...
	<div class="mml-script-footer" v-if="!isView">
		<div>
	...
	<el-dialog  top="25vh" width="550" custom-class="normal-padding"
		:visible.sync="dlShow"
		:append-to-body="true"
	>
		<div slot="title">
		...
		<el-ctable ref="resultList" class="table-width-border"
			height="300"
			:data="resultList"
			:rownumber="true"
...
new Vue({
	...
	methods:{ 
		...
		*/ 
		...
		downloadTpl() {
			var vm = this,
				url = '${ctx}/task/MMLScript/exportMMLTemplete.action';
