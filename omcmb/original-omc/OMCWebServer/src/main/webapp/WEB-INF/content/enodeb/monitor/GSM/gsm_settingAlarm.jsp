...
<style>
#gsmSettingAlarmDetailPages .alarmMinorIcon::before,
#gsmSettingAlarmPage .alarmMinorIcon::before{
	color: #FFDA41;
	font-size: 18px;
}
#gsmSettingAlarmDetailPages .alarmMajorIcon::before,
#gsmSettingAlarmPage .alarmMajorIcon::before{
	color: #FF973E;
	font-size: 18px;
}
#gsmSettingAlarmDetailPages .alarmCriticalIcon::before,
#gsmSettingAlarmPage .alarmCriticalIcon::before{
	color: #FC5959;
	font-size: 18px;
}
#gsmSettingAlarmDetailPages .alarmWarningIcon::before,
#gsmSettingAlarmPage .alarmWarningIcon::before{
	color: #60BEFC;
	font-size: 18px;
}
#gsmSettingAlarmPage .disabledClass {
	cursor: not-allowed !important; 
	opacity: 0.4;
	font-size: 16px; 
}
#gsmSettingAlarmPage .defaultClass {
	cursor: pointer; 
	font-size: 16px; 
	color: rgba(0, 0, 0, 0.8);	
}
#gsmSettingAlarmPage .el-icon-operation-more-circle:hover, .el-icon-operation-more-circle:active {
	color: var(--main-color) !important; 
}
#gsmSettingAlarmPage .alarmItemTableBoxCls {
    height: 50%;
}
#gsmSettingAlarmDetailPages label{
	color: #7A7992;
	margin-right:5px;
	text-align:left;
...
#gsmSettingAlarmDetailPages span{
	color: rgba(0, 0, 0, 0.8);
	width: 730px;
	word-wrap: break-word;
}
#gsmSettingAlarmDetailPages div{
	margin-bottom:20px;
	font-size:12px;
	display: flex;
	width: 940px;
...
<div id="gsmSettingAlarmPage" class='commonWarp' style='background: #FFFFFF;width: 100%; height: 100%;'>
	...
	<el-dialog :title="'<%=rb.getString("XiangXiXinXi")%>'" :visible.sync="showAlarmInfo" :close-on-click-modal="false" @close="alarmInfoDialogClose" :append-to-body="true" top="15vh" width="1000" >
        <div id='gsmSettingAlarmDetailPages'>
            <div>
...
<script type="text/javascript">
	var gsmSettingAlarmPageVue = new Vue({
	    el: '#gsmSettingAlarmPage',
	    data() {
	    	return {
