...
cp "$TMP/complete.env" "$TMP/bad-redis-headroom.env"
set_key "$TMP/bad-redis-headroom.env" REDIS_MAXMEMORY 4097MiB
expect_invalid bad-redis-headroom "$TMP/bad-redis-headroom.env" REDIS_MAXMEMORY
