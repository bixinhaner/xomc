...
grep -Fq 'idx_pm_anchors_15min_device_time_object' "$SQL"
grep -Fq 'idx_pm_anchors_15min_device_object' "$SQL"
grep -Fq 'idx_pm_anchors_15min_device_object_time' "$SQL"
grep -Fq 'idx_pm_metric_values_anchor_metric_time' "$SQL"
grep -Fq 'idx_pm_aggregation_results_device_view' "$SQL"
grep -Fq 'idx_pm_aggregation_results_device_metric_time' "$SQL"
